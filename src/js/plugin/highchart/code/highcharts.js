...
'use strict';
(function(U, M) {
    "object" === typeof module && module.exports ? (M["default"] = M,
    module.exports = U.document ? M(U) : M) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() {
        return M(U)
    ...
    function M(a, y, I, L) {
        a.hasOwnProperty(y) || (a[y] = L.apply(null, I),
        ...
        (function(a) {
            ...
            a.supportsPassiveEvents = function() {
                ...
                if (!a.isMS) {
                    ...
                    a.win.addEventListener && a.win.removeEventListener && (a.win.addEventListener("testPassive", a.noop, y),
    ...
    M(a, "Core/Utilities.js", [a["Core/Globals.js"]], function(a) {
        ...
        function w(c, b, f) {
            let n;
            if ("width" === b)
                return b = Math.min(c.offsetWidth, c.scrollWidth),
                f = c.getBoundingClientRect && c.getBoundingClientRect().width,
                f < b && f >= b - 1 && (b = Math.floor(f)),
                Math.max(0, b - (w(c, "padding-left", !0) || 0) - (w(c, "padding-right", !0) || 0));
            if ("height" === b)
                return Math.max(0, Math.min(c.offsetHeight, c.scrollHeight) - (w(c, "padding-top", !0) || 0) - (w(c, "padding-bottom", !0) || 0));
        ...
        function d(c, b, f, d) {
            ...
            if (r.createEvent && (c.dispatchEvent || c.fireEvent && c !== a)) {
                ...
                let d = c
                  , K = !1;
                for (; d.hcEvents; )
                    Object.hasOwnProperty.call(d, "hcEvents") && d.hcEvents[b] && (n.length && (K = !0),
        ...
        q.jQuery && (q.jQuery.fn.highcharts = function() {
            ...
            if (this[0])
                return c[0] ? (new (a[L(c[0]) ? c.shift() : "Chart"])(this[0],c[0],c[1]),
                this) : k[l(this[0], "data-highcharts-chart")]
        }
        );
        G = {
                    ...
                    E(b, function(f, q) {
                        if (!k && d && -1 < d.indexOf(q) && c[q]) {
                            ...
                            for (let b = 0; b < Math.max(f.length, c[q].length); b++)
                                c[q][b] && (void 0 === f[b] ? K[q][b] = c[q][b] : (K[q][b] = {},
                                n(f[b], c[q][b], K[q][b], k + 1)))
                        } else if (z(f, !0) && !f.nodeType)
                            K[q] = C(f) ? [] : {},
                            n(f, c[q] || {}, K[q], k + 1),
                            0 !== Object.keys(K[q]).length || "colorAxis" === q && 0 === k || delete K[q];
                ...
                b.forEach(b => {
                    if (1 < b.length)
                        for (q = n = b.length - 1; 0 < q; q--)
                            k = b[q] - b[q - 1],
                            0 > k && !c ? (null === f || void 0 === f ? void 0 : f(),
                            f = void 0) : k && ("undefined" === typeof d || k < d) && (d = k)
                }
                );
                return d
            },
            ...
            getNestedProperty: function(b, f) {
                for (b = b.split("."); b.length && v(f); ) {
                    ...
                    f = f[c];
                    if (!v(f) || "function" === typeof f || "number" === typeof f.nodeType || f === q)
                        return
                }
                return f
            },
            ...
            normalizeTickInterval: function(b, f, d, k, K) {
                ...
                d = m(d, g(b));
                const n = b / d;
                f || (f = K ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10],
                !1 === k && (1 === d ? f = f.filter(function(b) {
                    return 0 === b % 1
                }) : .1 >= d && (f = [1 / d])));
                for (k = 0; k < f.length && !(c = f[k],
                K && c * d >= b || !K && n <= (f[k] + (f[k + 1] || f[k])) / 2); k++)
                    ;
    ...
    M(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y) {
        const {win: x} = a
          , {defined: L, error: C, extend: z, isObject: H, merge: B, objectEach: u, pad: v, pick: l, splat: p, timeUnits: t} = y
        ...
        class g {
            ...
            set(e, g, h) {
                if (this.variableTimezone || this.timezoneOffset) {
                    if ("Milliseconds" === e || "Seconds" === e || "Minutes" === e && 0 === this.getTimezoneOffset(g) % 36E5)
                        return g["setUTC" + e](h);
            ...
            makeTime(e, g, m, p, d, k) {
                let r, q, w;
                this.useUTC ? (r = this.Date.UTC.apply(0, arguments),
                q = this.getTimezoneOffset(r),
                r += q,
                w = this.getTimezoneOffset(r),
                q !== w ? r += w - q : q - 36E5 !== this.getTimezoneOffset(r - 36E5) || h || (r -= 36E5)) : r = (new this.Date(e,g,l(m, 1),l(p, 0),l(d, 0),l(k, 0))).getTime();
                return r
            }
            ...
            dateFormat(e, g, h) {
                ...
                u(d, function(b, c) {
                    for (; -1 !== e.indexOf("%" + c); )
                        e = e.replace("%" + c, "function" === typeof b ? b.call(m, g) : b)
                });
            ...
            getTimeTicks(e, g, h, m) {
                ...
                if (L(g)) {
                    ...
                    for (q = 1; g < h; )
                        k.push(g),
                        g = w === t.year ? d.makeTime(c + q * b, 0) : w === t.month ? d.makeTime(c, m + q * b) : !f || w !== t.day && w !== t.week ? f && w === t.hour && 1 < b ? d.makeTime(c, m, n, e + q * b) : g + w * b : d.makeTime(c, m, n + q * b * (w === t.day ? 1 : 7)),
                        q++;
                    k.push(g);
    ...
    M(a, "Core/Defaults.js", [a["Core/Chart/ChartDefaults.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palettes.js"], a["Core/Time.js"], a["Core/Utilities.js"]], function(a, y, I, L, C, z) {
        ...
        a = {
            ...
            setOptions: function(a) {
                u(!0, v, a);
                if (a.time || a.global)
                    I.time ? I.time.update(u(v.global, v.time, a.global, a.time)) : I.time = l;
                return v
            }
        };
        "";
        ...
        class B {
            ...
            update() {
                ...
                if (this[v + "Setter"])
                    ...
                    a.attr ? a.element && a.attr(v, l, null, !0) : a.style[v] = l + this.unit;
                p && p.call(a, l, this)
            }
            run(a, v, l) {
                const p = this
                ...
                a !== v || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date,
                this.start = a,
                this.end = v,
                this.unit = l,
                this.now = this.start,
                ...
                m.elem = this.elem,
                m.prop = this.prop,
                m() && 1 === B.timers.push(m) && h(g)) : (delete t.curAnim[this.prop],
                t.complete && 0 === Object.keys(t.curAnim).length && t.complete.call(this.elem))
            }
            step(a) {
                const v = +new Date
                  , l = this.options
                  ...
                  , h = l.curAnim;
                let g;
                p.attr && !p.element ? a = !1 : a || v >= m + this.startTime ? (this.now = this.end,
                this.pos = 1,
                this.update(),
                g = h[this.prop] = !0,
                H(h, function(e) {
                ...
                g && t && t.call(p),
                a = !1) : (this.pos = l.easing((v - this.startTime) / m),
            ...
            initPath(a, v, l) {
                ...
                function t(d, k) {
                    for (; d.length < E; )
                        if (k = d[Math.floor(d.length / e) - 1].slice(),
                        "C" === k[0] && (k[1] = k[5],
                        k[2] = k[6]),
                        g) {
    ...
    M(a, "Core/Animation/AnimationUtilities.js", [a["Core/Animation/Fx.js"], a["Core/Utilities.js"]], function(a, y) {
        ...
        function L(l, m) {
            ...
            for (; h--; )
                a.timers[h].elem !== l || m && m !== a.timers[h].prop || (a.timers[h].stopped = !0)
        }
        ...
        return {
            animate: function(p, m, h) {
                ...
                l(m, function(d, k) {
                    ...
                    E = new a(p,h,k);
                    w = void 0;
                    "d" === k && H(m.d) ? (E.paths = E.initPath(p, p.pathArray, m.d),
                    E.toD = m.d,
                    g = 0,
                    w = 1) : p.attr ? g = p.attr(k) : (g = parseFloat(z(p, k)) || 0,
                    "opacity" !== k && (e = "px"));
                    w || (w = d);
    ...
    M(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y) {
        const {SVG_NS: x, win: L} = a
          , {attr: C, createElement: z, css: H, error: B, isFunction: u, isString: v, objectEach: l, splat: p} = y;
        ({trustedTypes: y} = L);
    ...
    M(a, "Core/Templating.js", [a["Core/Defaults.js"], a["Core/Utilities.js"]], function(a, y) {
            ...
            for (; null !== (f = a.exec(h)); ) {
                ...
                if (c.isBlock && c.fn && (f[1] === `/${c.fn}` || D))
                    if (n)
                        ...
                        void 0 === c.body ? (c.body = K,
                        c.startInner = f.index + f[0].length) : c.elseBody = K;
                        c.find += K + f[0];
                        D || (v.push(c),
                        c = void 0)
                    }
                    ...
                    c.isBlock || v.push(c);
                if (b && (null === c || void 0 === c || !c.isBlock))
                    break
            }
            v.forEach(c => {
                ...
                if (e) {
                    ...
                    a = K.split(":"),
                    A = b(a.shift() || ""),
                    a.length && "number" === typeof A && (a = a.join(":"),
                    d.test(a) ? (w = parseInt((a.match(k) || ["", "-1"])[1], 10),
                    null !== A && (A = G(A, w, r.decimalPoint, -1 < a.indexOf(",") ? r.thousandsSep : ""))) : A = q.dateFormat(a, A));
        ...
        const {defaultOptions: C, defaultTime: z} = a
          , {extend: H, getNestedProperty: B, isArray: u, isNumber: v, isObject: l, pick: p, pInt: t} = y
          , m = {
            add: (h, g) => h + g,
            divide: (h, g) => 0 !== g ? h / g : "",
            eq: (h, g) => h == g,
        ...
        (function(a) {
            function y(a, u, v) {
                ...
                for (a = a.map(e => ({
                    ...
                    for (h = a.length; h--; )
                        p = a[h],
                        t = (Math.min.apply(0, p.targets) + Math.max.apply(0, p.targets)) / 2,
                        p.pos = x(t - p.size * p.align, 0, u - p.size);
                    h = a.length;
                    for (g = !1; h--; )
                        0 < h && a[h - 1].pos + a[h - 1].size > a[h].pos && (a[h - 1].size += a[h].size,
                        a[h - 1].targets = a[h - 1].targets.concat(a[h].targets),
                        a[h - 1].align = .5,
                        a[h - 1].pos + a[h - 1].size > u && (a[h - 1].pos = u - a[h - 1].size),
                        a.splice(h, 1),
                        g = !0)
                }
                l.push.apply(l, e);
                ...
                a.some(e => {
                    ...
                    return (e.targets || []).some( () => {
                        ...
                        if ("undefined" !== typeof v && Math.abs(l[h].pos - l[h].target) > v)
                            return l.slice(0, h + 1).forEach(d => delete d.pos),
                            l.reducedLen = (l.reducedLen || u) - .1 * u,
                            l.reducedLen > .1 * u && y(l, u, v),
                            !0;
                        g += l[h].size;
                        h++;
                        return !1
    ...
    M(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y, I, L) {
        const {animate: x, animObject: z, stop: H} = a
          ...
          , {addEvent: t, attr: m, createElement: h, css: g, defined: e, erase: w, extend: E, fireEvent: F, isArray: d, isFunction: k, isObject: r, isString: q, merge: G, objectEach: b, pick: f, pInt: c, syncTimeout: n, uniqueKey: P} = L;
        class D {
            constructor() {
                this.element = void 0;
                this.onEvents = {};
            ...
            attr(c, f, d, k) {
                ...
                let A, q, g = this, a, K;
                "string" === typeof c && "undefined" !== typeof f && (A = c,
                c = {},
                c[A] = f);
                "string" === typeof c ? g = (this[c + "Getter"] || this._defaultGetter).call(this, c, n) : (b(c, function(b, f) {
                    a = !1;
                    k || H(this, f);
                    this.symbolName && -1 !== e.indexOf(f) && (q || (this.symbolAttr(c),
                    q = !0),
                    a = !0);
                    !this.rotation || "x" !== f && "y" !== f || (this.doTransform = !0);
                    a || (K = this[f + "Setter"] || this._defaultSetter,
                    K.call(this, b, f, n))
                }, this),
                this.afterSetters());
                d && d.call(this);
            ...
            complexColor(c, f, k) {
                ...
                F(this.renderer, "complexColor", {
                    ...
                    if (g) {
                        ...
                        "radialGradient" === g && m && !e(A.gradientUnits) && (a = A,
                        ...
                        if (r[w])
                            ...
                            K.forEach(function(c) {
                                0 === c[1].indexOf("rgba") ? (q = y.parse(c[1]),
                                h = q.get("rgb"),
                                J = q.get("a")) : (h = c[1],
                                J = 1);
            ...
            css(f) {
                ...
                if (q) {
                    ...
                    const b = G(f);
                    n.namespaceURI === this.SVG_NS && (["textOutline", "textOverflow", "width"].forEach(c => b && delete b[c]),
            ...
            destroy() {
                ...
                for (c.safeRemoveChild(f); n && n.div && 0 === n.div.childNodes.length; )
                    f = n.parentGroup,
            ...
            dSetter(b, c, f) {
                d(b) && ("string" === typeof b[0] && (b = this.renderer.pathToSegments(b)),
                this.pathArray = b,
                b = b.reduce( (b, c, f) => c && c.join ? (f ? b + " " : "") + c.join(" ") : (c || "").toString(), ""));
            ...
            getBBox(b, c) {
                ...
                N += ["", q.rootFontSize, K, c, this.textWidth, d, a && a.textOverflow, a && a.fontWeight].join());
                N && !b && (J = r[N]);
                if (!J) {
                    if (m || q.forExport) {
                        try {
            ...
            setTextPath(b, c) {
                ...
                delete d.textPath);
                this.added && (d.textCache = "",
                this.renderer.buildText(d));
                return this
            }
            shadow(b) {
                var c;
            ...
            strokeWidth() {
                ...
                let f = 0, d;
                b.indexOf("px") === b.length - 2 ? f = c(b) : "" !== b && (d = u.createElementNS(l, "rect"),
                m(d, {
                    width: b,
                    "stroke-width": 0
                }),
            ...
            updateTransform() {
                const {element: b, matrix: c, rotation: d=0, scaleX: k, scaleY: n, translateX: q=0, translateY: A=0} = this
                  , g = ["translate(" + q + "," + A + ")"];
            ...
            zIndexSetter(b, f) {
                ...
                var a = this.added;
                let r;
                e(b) ? (q.setAttribute("data-z-index", b),
                b = +b,
                this[f] === b && (a = !1)) : e(this[f]) && q.removeAttribute("data-z-index");
                this[f] = b;
                if (a) {
                    ...
                    for (r = f.length - 1; 0 <= r && !A; r--)
                        ...
                        k !== q)
                            if (0 > b && g && !d && !r)
                                n.insertBefore(q, f[r]),
                                A = !0;
                            else if (c(a) <= b || g && (!e(b) || 0 <= b))
                                n.insertBefore(q, f[r + 1]),
                                A = !0;
                    A || (n.insertBefore(q, f[d ? 3 : 0]),
                    A = !0)
                }
                return A
            }
    ...
    M(a, "Core/Renderer/SVG/SVGLabel.js", [a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function(a, y) {
        ...
        class u extends a {
            ...
            alignSetter(a) {
                ...
                this.bBox && C(this.xSetting) && this.attr({
                    x: this.xSetting
                }))
            }
            anchorXSetter(a, l) {
            ...
            paddingSetter(a, l) {
                C(a) ? a !== this[l] && (this[l] = a,
                this.updateTextPadding()) : this[l] = void 0
            }
            rSetter(a, l) {
                this.boxAttr(l, a)
            }
            ...
            updateBoxSize() {
                ...
                this.needsBox && !a.textPath && (this.box || (a = this.box = this.symbolKey ? this.renderer.symbol(this.symbolKey) : this.renderer.rect(),
    ...
    M(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function(a) {
        function x(a, u, v, l, p) {
            ...
            if (p) {
                ...
                C(g) && (r = ["A", g, g, 0, k, C(p.clockwise) ? 1 - p.clockwise : 0, a + g * w, u + g * E],
                r.params = {
                    start: l,
                    end: m,
                    cx: a,
    ...
    M(a, "Core/Renderer/SVG/TextBuilder.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y, I) {
        const {doc: x, SVG_NS: C, win: z} = y
          , {attr: H, extend: B, fireEvent: u, isString: v, objectEach: l, pick: p} = I;
        class t {
            constructor(a) {
                const h = a.styles;
            ...
            buildSVG() {
                ...
                if (d !== m.textCache) {
                    ...
                    for (d = l.length; d--; )
                        h.removeChild(l[d]);
                    w || this.ellipsis || this.width || m.textPath || -1 !== e.indexOf(" ") && (!this.noWrap || t.test(e)) ? "" !== e && (g && g.appendChild(h),
                    e = new a(e),
                    this.modifyTree(e.nodes),
                    e.addToDOM(h),
                    this.modifyDOM(),
                    this.ellipsis && -1 !== (h.textContent || "").indexOf("\u2026") && m.attr("title", this.unescapeEntities(m.textStr || "", ["&lt;", "&gt;"])),
                    g && g.removeChild(h)) : h.appendChild(x.createTextNode(this.unescapeEntities(e)));
            ...
            modifyDOM() {
                ...
                [].forEach.call(a.element.querySelectorAll("tspan.highcharts-br"), (e, d) => {
                    e.nextSibling && e.previousSibling && (0 === d && 1 === e.previousSibling.nodeType && (a.firstLineMetrics = a.renderer.fontMetrics(e.previousSibling)),
                    H(e, {
                ...
                if (e) {
                    var w = (g, d) => {
                        ...
                        let b = 0
                          , f = a.actualWidth;
                        if (this.ellipsis)
                            k && this.truncate(g, k, void 0, 0, Math.max(0, e - .8 * m), (b, f) => b.substring(0, f) + "\u2026");
                        else if (q) {
                            k = [];
                            ...
                            for (; r.length; )
                                r.length && !this.noWrap && 0 < b && (k.push(g.textContent || ""),
                                g.textContent = r.join(" ").replace(/- /g, "-")),
                                this.truncate(g, void 0, r, 0 === b ? f || 0 : 0, e, (b, f) => r.slice(0, f).join(" ").replace(/- /g, "-")),
                                f = a.actualWidth,
                                b++;
                            q.forEach(b => {
                                d.insertBefore(b, g)
                      ...
                      , l = e => {
                        [].slice.call(e.childNodes).forEach(d => {
                            d.nodeType === z.Node.TEXT_NODE ? w(d, e) : (-1 !== d.className.baseVal.indexOf("highcharts-br") && (a.actualWidth = 0),
                            l(d))
                        }
                        )
                    }
            ...
            modifyTree(a) {
                const h = (g, e) => {
                    ...
                    if ("b" === d || "strong" === d)
                        ...
                        k ? m["class"] = "highcharts-emphasized" : p.fontStyle = "italic";
                    p && p.color && (p.fill = p.color);
                    "br" === d ? (m["class"] = "highcharts-br",
                    g.textContent = "\u200b",
                    (e = a[e + 1]) && e.textContent && (e.textContent = e.textContent.replace(/^ +/gm, ""))) : "a" === d && l && l.some(d => "#text" === d.tagName) && (g.children = [{
                        children: l,
                        tagName: "tspan"
                    }]);
            ...
            truncate(a, h, g, e, l, p) {
                ...
                const c = function(b, c) {
                    b = c || b;
                    if ((c = a.parentNode) && "undefined" === typeof k[b] && c.getSubStringLength)
                        try {
    ...
    M(a, "Core/Renderer/SVG/SVGRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGLabel.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Renderer/SVG/TextBuilder.js"], a["Core/Utilities.js"]], function(a, y, I, L, C, z, H, B, u) {
        const {charts: v, deg2rad: l, doc: p, isFirefox: t, isMS: m, isWebKit: h, noop: g, SVG_NS: e, symbolSizes: w, win: E} = I
          , {addEvent: F, attr: d, createElement: k, css: r, defined: q, destroyObjectProperties: G, extend: b, isArray: f, isNumber: c, isObject: n, isString: P, merge: D, pick: K, pInt: x, uniqueKey: T} = u;
        let Z;
        class V {
            ...
            rect(c, f, a, k, e, q) {
                ...
                this.styledMode || ("undefined" !== typeof q && (c["stroke-width"] = q,
                b(c, A.crisp(c))),
                c.fill = "none");
            ...
            symbol(c, f, a, n, e, g) {
                ...
                let D, G, P, t;
                if (l)
                    "number" === typeof f && (G = l.call(this.symbols, Math.round(f || 0), Math.round(a || 0), n || 0, e || 0, g)),
                    D = this.path(G),
                    ...
                    ["width", "height"].forEach(function(c) {
                        b[c + "Setter"] = function(b, c) {
                            this[c] = b;
                            const {alignByTranslate: f, element: a, width: k, height: A, imgwidth: n, imgheight: e} = this;
                            b = this["img" + c];
                            if (q(b)) {
                                let J = 1;
                                g && "within" === g.backgroundSize && k && A ? (J = Math.min(k / n, A / e),
                                d(a, {
                ...
                if (!d || this.forExport && !this.allowHTML)
                    b.xSetter = function(b, c, f) {
                        ...
                        for (let f = 0, k; f < d.length; f++)
                            k = d[f],
                            k.getAttribute(c) === a && k.setAttribute(c, b);
                        f.setAttribute(c, b)
                    }
                    ;
                return b
            ...
            pathToSegments(b) {
                ...
                for (let k = 0; k < b.length; k++)
                    P(d[0]) && c(b[k]) && d.length === a[d[0].toUpperCase()] && b.splice(k, 0, d[0].replace("M", "L").replace("m", "l")),
                    "string" === typeof b[k] && (d.length && f.push(d.slice(0)),
                    d.length = 0),
                    d.push(b[k]);
                f.push(d.slice(0));
                return f
    ...
    M(a, "Core/Renderer/HTML/HTMLElement.js", [a["Core/Globals.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function(a, y, I) {
        ...
        class m extends y {
            ...
            htmlUpdateTransform() {
                if (this.added) {
                    ...
                    if ("SPAN" === g.tagName) {
                        ...
                        h !== this.cTT && (a = a.fontMetrics(g).b,
                        !u(d) || d === (this.oldRotation || 0) && l === this.oldAlign || this.setSpanRotation(d, t, a),
                        this.getSpanCorrection(!u(d) && this.textPxLength || g.offsetWidth, a, t, d, l));
                        B(g, {
            ...
            setSpanRotation(a, g, e) {
                ...
                m && (h[m] = h.transform = "rotate(" + a + "deg)",
                h[m + (x ? "Origin" : "-origin")] = h.transformOrigin = 100 * g + "% " + e + "px",
                B(this.element, h))
            }
        }
        return m
        ...
        (function(a) {
            a.registerEventOptions = function(a, u) {
                ...
                L(u.events, function(v, l) {
                    a.eventOptions[l] !== v && (a.eventOptions[l] && (C(a, l, a.eventOptions[l]),
                    delete a.eventOptions[l]),
                    I(v) && (a.eventOptions[l] = v,
                    x(a, l, v, {
                        order: 0
                    })))
                })
    ...
    M(a, "Core/Axis/Tick.js", [a["Core/Templating.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y, I) {
        const {deg2rad: x} = y
          , {clamp: C, correctFloat: z, defined: H, destroyObjectProperties: B, extend: u, fireEvent: v, isNumber: l, merge: p, objectEach: t, pick: m} = I;
        class h {
            ...
            addLabel() {
                ...
                e.dateTime && (G ? (D = p.time.resolveDTLFormat(h.dateTimeLabelFormats[!h.grid && G.higherRanks[r] || G.unitName]),
                P = D.main) : l(t) && (P = e.dateTime.getXDateFormat(t, h.dateTimeLabelFormats || {})));
                g.isFirst = b;
                g.isLast = f;
                const x = {
                    axis: e,
                ...
                const B = b => q.formatter ? q.formatter.call(b, b) : q.format ? (b.text = e.defaultLabelFormatter.call(b, b),
                a.format(q.format, b, p)) : e.defaultLabelFormatter.call(b, b);
                h = B.call(x, x);
                const y = D && D.list;
            ...
            createLabel(a, e, h) {
                const g = this.axis
                  , m = g.chart;
                if (a = H(e) && h.enabled ? m.renderer.text(e, a.x, a.y, h.useHTML).add(g.labelGroup) : null)
            ...
            handleOverflow(a) {
                ...
                if (q || "justify" !== g.overflow)
                    0 > q && h - p * b < k ? D = Math.round(h / Math.cos(q * x) - k) : 0 < q && h + p * b > d && (D = Math.round((l - h) / Math.cos(q * x)));
                else if (l = h + (1 - p) * b,
                h - p * b < k ? n = a.x + n * (1 - p) - k : l > d && (n = d - a.x + n * p,
                t = -1),
                n = Math.min(f, n),
                n < f && "center" === e.labelAlign && (a.x += t * (f - n - p * (f - Math.min(b, n)))),
                b > n || e.autoRotation && (r.styles || {}).width)
                    D = n;
                D && (this.shortenLabel ? this.shortenLabel() : (c.width = Math.floor(D) + "px",
            ...
            moveLabel(a, e) {
                ...
                const m = g.axis;
                let d = !1;
                h && h.textStr === a ? (g.movedLabel = h,
                d = !0,
                delete g.label) : t(m.ticks, function(k) {
                    d || k.isNew || k === g || !k.label || k.label.textStr !== a || (g.movedLabel = k.label,
                    d = !0,
                    k.labelPos = g.movedLabel.xy,
                    delete k.label)
                });
                d || !g.labelPos && !h || (h = g.labelPos || h.xy,
            ...
            renderGridLine(a, e, h) {
                ...
                "minor" === this.type && (f = l.minorGridLineWidth,
                c = l.minorGridLineColor,
                n = l.minorGridLineDashStyle);
                b || (g.chart.styledMode || (d.stroke = c,
                d["stroke-width"] = f || 0,
                d.dashstyle = n),
                r || (d.zIndex = 1),
                a && (e = 0),
                this.gridLine = b = p.path().attr(d).addClass("highcharts-" + (r ? r + "-" : "") + "grid-line").add(g.gridGroup));
            ...
            renderMark(a, e, h) {
                ...
                let b = this.mark;
                const f = !b;
                r && (g.opposite && (r[0] = -r[0]),
                b || (this.mark = b = d.path().addClass("highcharts-" + (k ? k + "-" : "") + "tick").add(g.axisGroup),
                g.chart.styledMode || b.attr({
                    stroke: l,
                    "stroke-width": p
                })),
                b[f ? "attr" : "animate"]({
            ...
            renderLabel(a, e, h, p) {
                ...
                a = a.y;
                let f = !0;
                r && l(b) && (r.xy = a = this.getLabelPosition(b, a, r, d, q, g, p, t),
                this.isFirst && !this.isLast && !k.showFirstLabel || this.isLast && !this.isFirst && !k.showLastLabel ? f = !1 : !d || q.step || q.rotation || e || 0 === h || this.handleOverflow(a),
                t && p % t && (f = !1),
                f && l(a.y) ? (a.opacity = h,
                r[this.isNewLabel ? "attr" : "animate"](a).show(!0),
                this.isNewLabel = !1) : (r.hide(),
                this.isNewLabel = !0))
            }
            replaceMovedLabel() {
                const a = this.label
    ...
    M(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Color/Color.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Axis/Tick.js"], a["Core/Utilities.js"]], function(a, y, I, L, C, z, H, B) {
        const {animObject: u} = a
          ...
          , {deg2rad: p} = z
          , {arrayMax: t, arrayMin: m, clamp: h, correctFloat: g, defined: e, destroyObjectProperties: w, erase: x, error: F, extend: d, fireEvent: k, getClosestDistance: r, insertItem: q, isArray: G, isNumber: b, isString: f, merge: c, normalizeTickInterval: n, objectEach: P, pick: D, relativeLength: K, removeEvent: X, splat: T, syncTimeout: Z} = B
        ...
        class Y {
            ...
            init(c, f, a=this.coll) {
                ...
                -1 === c.axes.indexOf(this) && (d ? c.axes.splice(c.xAxis.length, 0, this) : c.axes.push(this),
                q(this, c[this.coll]));
            ...
            defaultLabelFormatter(c) {
                ...
                if (f.categories)
                    ...
                    for (; q-- && "undefined" === typeof g; )
                        f = Math.pow(n, q + 1),
                        e >= f && 0 === 10 * a % f && null !== A[q] && 0 !== a && (g = c(a / f, -1) + A[q]);
                ...
                k(this, "getSeriesExtremes", null, function() {
                    ...
                    c.series.forEach(function(d) {
                        if (d.visible || !f.options.chart.ignoreHiddenSeries) {
                            ...
                            if (c.isXAxis)
                                (k = d.xData) && k.length && (k = c.logarithmic ? k.filter(b => 0 < b) : k,
                                a = d.getXExtremes(k),
                                n = a.min,
                                A = a.max,
                                b(n) || n instanceof Date || (k = k.filter(b),
                                a = d.getXExtremes(k),
                                n = a.min,
                                A = a.max),
                                k.length && (c.dataMin = Math.min(D(c.dataMin, n), n),
                                c.dataMax = Math.max(D(c.dataMax, A), A)));
                            else if (d = d.applyExtremes(),
                            b(d.dataMin) && (n = d.dataMin,
                            c.dataMin = Math.min(D(c.dataMin, n), n)),
                            b(d.dataMax) && (A = d.dataMax,
                            c.dataMax = Math.max(D(c.dataMax, A), A)),
                            e(f) && (c.threshold = f),
            ...
            translate(c, f, a, d, k, n) {
                ...
                h -= J * (e.sector || e.len));
                f ? (n = (c * J + h - q) / d + A,
                k && (n = e.lin2val(n))) : (k && (c = e.val2lin(c)),
                c = J * (c - A) * d,
            ...
            getPlotLinePath(c) {
                ...
                k(this, "getPlotLinePath", c, function(c) {
                    ...
                    b(p) ? a.horiz ? (w = e,
                    Q = r - a.bottom,
                    P = R = f(P, n, n + a.width)) : (P = n,
                    R = m - a.right,
                    w = Q = f(w, e, e + a.height)) : (K = !0,
                    t = !1);
            ...
            getMinorTickPositions() {
                ...
                if (k && k / f < this.len / 3) {
                    ...
                    if (k)
                        ...
                        n = n.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(f), d, a, b.startOfWeek));
                    else
            ...
            adjustForMinRange() {
                ...
                a - f < this.minRange && (n = this.dataMax - this.dataMin >= this.minRange,
                k = this.minRange,
                a = (k - a + f) / 2,
                d = [f - a, D(b.min, f - a)],
            ...
            nameToX(b) {
                ...
                this.names.keys[b.name] = d) : b.x && (d = b.x);
                return d
            }
            updateNames() {
                const b = this
                ...
                (this.series || []).forEach(function(c) {
                    ...
                    c.data.forEach(function(f, a) {
                        let d;
                        f && f.options && "undefined" !== typeof f.name && (d = b.nameToX(f),
                        "undefined" !== typeof d && d !== f.x && (f.x = d,
                        c.xData[a] = d))
                    })
                }))
            }
            ...
            setTickInterval(c) {
                ...
                let m = d.maxPadding
                  , l = d.minPadding;
                let p = b(d.tickInterval) && 0 <= d.tickInterval ? d.tickInterval : void 0, t = b(this.threshold) ? this.threshold : null, P, w, K;
                ...
                if (q) {
                    ...
                    r && e(t) && (this.dataMin >= t ? (R = t,
                    l = 0) : this.dataMax <= t && (P = t,
                    m = 0)),
                    this.min = D(w, R, this.dataMin),
                    this.max = D(K, P, this.dataMax);
                a && (this.positiveValuesOnly && !c && 0 >= Math.min(this.min, D(this.dataMin, this.min)) && F(10, 1, f),
                this.min = g(a.log2lin(this.min), 16),
                this.max = g(a.log2lin(this.max), 16));
                this.range && e(this.max) && (this.userMin = this.min = w = Math.max(this.dataMin, this.minFromRange()),
                ...
                !(A || this.axisPointRange || this.stacking && this.stacking.usePercentage || q) && e(this.min) && e(this.max) && (f = this.max - this.min) && (!e(w) && l && (this.min -= f * l),
                !e(K) && m && (this.max += f * m));
                ...
                r && e(this.dataMin) && (t = t || 0,
                !e(w) && this.min < t && this.dataMin >= t ? this.min = this.options.minRange ? Math.min(t, this.max - this.minRange) : t : !e(K) && this.max > t && this.dataMax <= t && (this.max = this.options.minRange ? Math.max(t, this.min + this.minRange) : t));
            ...
            setTickPositions() {
                ...
                if (f)
                    ...
                    if (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)))
                        if (this.dateTime)
                            q = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, c.units), this.min, this.max, c.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, !0);
                        else if (this.logarithmic)
                            q = this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max);
                        else
                            for (d = c = this.tickInterval; d <= 2 * c; )
                                if (q = this.getLinearTickPositions(this.tickInterval, this.min, this.max),
                        ...
                        q = [this.min, this.max],
                        F(19, !1, this.chart);
                    q.length > this.len && (q = [q[0], q[q.length - 1]],
                    q[0] === q[1] && (q.length = 1));
                    a && (this.tickPositions = q,
                    (h = a.apply(this, [this.min, this.max])) && (q = h))
                }
                this.tickPositions = q;
                this.paddedTicks = q.slice(0);
                this.trimTicks(q, g, n);
                !this.isLinked && b(this.min) && b(this.max) && (this.single && 2 > q.length && !this.categories && !this.series.some(b => b.is("heatmap") && "between" === b.options.pointPlacement) && (this.min -= .5,
                this.max += .5),
            ...
            alignToOthers() {
                ...
                if ((!1 !== this.chart.options.chart.alignTicks && a.alignTicks || d) && !1 !== a.startOnTick && !1 !== a.endOnTick && !c.logarithmic) {
                    ...
                    this.chart[this.coll].forEach(function(d) {
                        const {series: k} = d;
                        k.length && k.some(b => b.visible) && d !== c && b(d) === a && (n = !0,
                        f.push(d))
                    })
                }
                if (n && d) {
            ...
            getThresholdAlignment(c) {
                ...
                if (b(this.threshold))
                    return c = h((this.threshold - (this.dataMin || 0)) / ((this.dataMax || 0) - (this.dataMin || 0)), 0, 1),
            ...
            getTickAmount() {
                ...
                4 > f && (this.finalTickAmt = f,
                f = 5);
                this.tickAmount = f
            }
            adjustTickAmount() {
                const c = this
                  , {finalTickAmt: f, max: a, min: d, options: k, tickPositions: n, tickAmount: q, thresholdAlignment: h} = c
                  , r = n && n.length;
                var m = D(c.threshold, c.softThreshold ? 0 : null);
                var l = c.tickInterval;
                let p;
                b(h) && (p = .5 > h ? Math.ceil(h * (q - 1)) : Math.floor(h * (q - 1)),
                k.reversed && (p = q - 1 - p));
                    ...
                    if (b(p) && b(c.threshold)) {
                        for (; n[p] !== m || n.length !== q || n[0] > d || n[n.length - 1] < a; ) {
                            ...
                            for (n.push(c.threshold); n.length < q; )
                                void 0 === n[p] || n[p] > c.threshold ? n.unshift(g(n[0] - l)) : n.push(g(n[n.length - 1] + l));
                            if (l > 8 * c.tickInterval)
                                break;
                            l *= 2
                        }
                        h()
                        ...
                        for (; n.length < q; )
                            n.length % 2 || d === m ? n.push(g(n[n.length - 1] + l)) : n.unshift(g(n[0] - l));
                        h()
                    }
                    if (e(f)) {
                        for (l = m = n.length; l--; )
                            (3 === f && 1 === l % 2 || 2 >= f && 0 < l && l < m - 1) && n.splice(l, 1);
            ...
            setScale() {
                ...
                f || b || c || this.isLinked || this.forceRedraw || this.userMin !== (this.old && this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers() ? (this.stacking && (this.stacking.resetStacks(),
                this.stacking.buildStacks()),
                this.forceRedraw = !1,
                this.userMinRange || (this.minRange = void 0),
                this.getSeriesExtremes(),
                this.setTickInterval(),
                this.isDirty || (this.isDirty = f || this.min !== (this.old && this.old.min) || this.max !== (this.old && this.old.max))) : this.stacking && this.stacking.cleanStacks();
            ...
            zoom(b, c) {
                ...
                k(this, "zoom", b, function(b) {
                    let c = b.newMin
                      , n = b.newMax;
                    if (c !== f.min || n !== f.max)
                        f.allowZoomOutside || (e(a) && (c < q && (c = q),
                        c > g && (c = g)),
                        e(d) && (n < q && (n = q),
                        n > g && (n = g))),
                        f.displayBtn = "undefined" !== typeof c || "undefined" !== typeof n,
            ...
            unsquish() {
                ...
                if (f) {
                    if (c.staggerLines || (b(n) ? m = [n] : d < c.autoRotationLimit && (m = c.autoRotation)),
                    m) {
                        let b;
                        for (const c of m)
                            if (c === n || c && -90 <= c && 90 >= c)
            ...
            renderUnsquish() {
                ...
                if (this.autoRotation)
                    D > g && D > r.h ? h.rotation = this.labelRotation : this.labelRotation = 0;
                else if (q && (l = g,
                !m))
                    for (p = "clip",
                    g = a.length; !e && g--; ) {
                ...
                h.rotation && (l = D > .5 * b.chartHeight ? .33 * b.chartHeight : D,
                m || (p = "ellipsis"));
                if (this.labelAlign = n.align || this.autoLabelAlign(this.labelRotation))
                ...
                a.forEach(function(b) {
                    const c = (b = d[b]) && b.label
                      ...
                      , a = {};
                    c && (c.attr(h),
                    b.shortenLabel ? b.shortenLabel() : l && !f && "nowrap" !== k.whiteSpace && (l < c.textPxLength || "SPAN" === c.element.tagName) ? (a.width = l + "px",
                    m || (a.textOverflow = c.specificTextOverflow || p),
                    c.css(a)) : c.styles && c.styles.width && !a.width && !f && c.css({
                        width: null
                    }),
            ...
            addTitle(b) {
                ...
                this.axisTitle = f.text(n.text || "", 0, 0, n.useHTML).attr({
                    zIndex: 7,
                    rotation: n.rotation,
                    align: e
            ...
            getOffset() {
                const c = this
                  , {chart: f, horiz: a, options: d, side: n, ticks: q, tickPositions: g, coll: h, axisParent: r} = c
                  , m = f.renderer
                ...
                c.renderUnsquish(),
                c.reserveSpaceDefault = 0 === n || 2 === n || {
                    1: "left",
                    3: "right"
                }[n] === c.labelAlign,
                D(w.reserveSpace, K ? !1 : null, "center" === c.labelAlign ? !0 : null, c.reserveSpaceDefault) && g.forEach(function(b) {
                    F = Math.max(q[b].getLabelSize(), F)
                }),
                c.staggerLines && (F *= c.staggerLines),
                c.labelOffset = F * (c.opposite ? -1 : 1)) : P(q, function(b, c) {
                    b.destroy();
                    delete q[c]
                });
                t && t.text && !1 !== t.enabled && (c.addTitle(ja),
                ja && !K && !1 !== t.reserveSpace && (c.titleOffset = u = c.axisTitle.getBBox()[a ? "height" : "width"],
                x = t.offset,
                ...
                "colorAxis" !== h && (w = this.tickSize("tick"),
                G[n] = Math.max(G[n], (c.axisTitleMargin || 0) + u + Q * c.offset, E, g && g.length && w ? w[0] + Q * c.offset : 0),
                G = !c.axisLine || d.offset ? 0 : 2 * Math.floor(c.axisLine.strokeWidth() / 2),
                R[l] = Math.max(R[l], G));
            ...
            render() {
                ...
                if (c.hasData() || n) {
                    ...
                    D && (0 === c.min || c.single) && (g[-1] || (g[-1] = new H(c,-1,null,!0)),
                    g[-1].render(-1)));
                    m && e.forEach(function(b, d) {
                        G = "undefined" !== typeof e[d + 1] ? e[d + 1] + D : c.max - D;
                        0 === d % 2 && b < c.max && G <= c.max + (f.polar ? -D : D) && (r[b] || (r[b] = new z.PlotLineOrBand(c)),
                        Q = b + D,
                        r[b].options = {
                    ...
                    c._addedPlotLB || (c._addedPlotLB = !0,
                ...
                [g, h, r].forEach(function(b) {
                    ...
                    Z(function() {
                        let f = c.length;
                        for (; f--; )
                            b[c[f]] && !b[c[f]].isActive && (b[c[f]].destroy(),
                            delete b[c[f]])
                ...
                t.isPlaced = !0,
                t[w ? "show" : "hide"](w));
                q && w && (q[q.isNew ? "attr" : "animate"](c.getTitlePosition(q)),
                q.isNew = !1);
    ...
    M(a, "Core/Axis/DateTimeAxis.js", [a["Core/Utilities.js"]], function(a) {
        ...
        (function(y) {
            ...
            y.compose = function(l) {
                a.pushUnique(v, l) && (l.keepProps.push("dateTime"),
            ...
            class l {
                ...
                normalizeTimeTickInterval(a, l) {
                    ...
                    l = m[m.length - 1];
                    let h = C[l[0]], g = l[1], e;
                    for (e = 0; e < m.length && !(l = m[e],
                    h = C[l[0]],
                    g = l[1],
                    m[e + 1] && a <= (h * g[g.length - 1] + C[m[e + 1][0]]) / 2); e++)
                        ;
    ...
    M(a, "Core/Axis/LogarithmicAxis.js", [a["Core/Utilities.js"]], function(a) {
        ...
        (function(y) {
            ...
            const u = [];
            y.compose = function(l) {
                a.pushUnique(u, l) && (l.keepProps.push("logarithmic"),
                x(l, "init", H),
                x(l, "afterInit", B));
                return l
            }
            ...
            class v {
                ...
                getLogTickPositions(a, p, t, m) {
                    ...
                    if (.5 <= a)
                        ...
                        e = Math.floor(p);
                        let h, w, d, k, r;
                        for (g = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; e < t + 1 && !r; e++)
                            for (w = g.length,
                            h = 0; h < w && !r; h++)
                                d = this.log2lin(this.lin2log(e) * g[h]),
                                d > p && (!m || k <= t) && "undefined" !== typeof k && l.push(k),
                                k > t && (r = !0),
                                k = d
                    } else
                        p = this.lin2log(p),
                        ...
                        a = L("auto" === a ? null : a, this.minorAutoInterval, e.tickPixelInterval / (m ? 5 : 1) * (t - p) / ((m ? g / h.tickPositions.length : g) || 1)),
                        a = I(a),
                ...
                if (a && g)
                    ...
                    e = 0; e < a.length; e += 2) {
                        const r = a[e]
                          ...
                          , m = g[e]
                          , b = g[e + 1];
                        "M" !== r[0] && "L" !== r[0] || "M" !== q[0] && "L" !== q[0] || "M" !== m[0] && "L" !== m[0] || "M" !== b[0] && "L" !== b[0] || (d && m[1] === r[1] ? (m[1] += h,
                        b[1] += h) : d || m[2] !== r[2] || (m[2] += h,
                        b[2] += h),
                        l.push(["M", r[1], r[2]], ["L", q[1], q[2]], ["L", b[1], b[2]], ["L", m[1], m[2]], ["Z"]));
                        l.isFlat = k
                    }
                return l
            }
    ...
    M(a, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [a["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], a["Core/Utilities.js"]], function(a, y) {
        ...
        class p {
            ...
            render() {
                ...
                G = g.log2lin(G),
                f = g.log2lin(f));
                m.chart.styledMode || (n ? (K.stroke = p || "#999999",
                K["stroke-width"] = l(e.width, 1),
                e.dashStyle && (K.dashstyle = e.dashStyle)) : P && (K.fill = p || "#e6e9ff",
                e.borderWidth && (K.stroke = e.borderColor,
                ...
                this.renderLabel(r, n, P, x)) : q && q.hide();
                return a
            }
            renderLabel(a, l, h, g) {
                const e = this.axis;
                ...
                p.alignValue && "left" !== p.alignValue || (a = a.clip ? e.width : e.chart.chartWidth,
                p.css({
    ...
    M(a, "Core/Tooltip.js", [a["Core/Templating.js"], a["Core/Globals.js"], a["Core/Renderer/RendererUtilities.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function(a, y, I, L, C) {
        const {format: x} = a
          , {doc: H, isSafari: B} = y
          , {distribute: u} = I
          , {addEvent: v, clamp: l, css: p, discardElement: t, extend: m, fireEvent: h, isArray: g, isNumber: e, isString: w, merge: E, pick: F, splat: d, syncTimeout: k} = C;
        class r {
            constructor(a, d) {
                this.allowShared = !0;
            ...
            getPosition(a, d, b) {
                ...
                const t = !this.followPointer && F(b.ttBelow, !f.inverted === q)
                  ...
                  , J = function() {
                    !1 !== w.apply(0, l) ? !1 !== G.apply(0, m) || p || (v(!0),
                    J()) : p ? n.x = n.y = 0 : (v(!0),
                    J())
                };
            ...
            move(a, d, b, f) {
                ...
                c.getLabel().attr(n);
                c.drawTracker();
                k && (C.clearTimeout(this.tooltipTimeout),
            ...
            refresh(a, k) {
                ...
                if (f.enabled && e.series) {
                    ...
                    var v = a[0]
                      , G = a[1];
                    m && this.allowShared ? (c.applyInactiveState(n),
                    n.forEach(function(b) {
                        b.setState("hover");
                        q.push(b.getLabelConfig())
                    }),
                    t = e.getLabelConfig(),
                    t.points = q) : t = e.getLabelConfig();
                    this.len = q.length;
                    ...
                    if (!1 === r)
                        ...
                        if (this.split && this.allowShared)
                            ...
                            let d = v
                              , g = G;
                            k && c.isDirectTouch && (d = k.chartX - b.plotLeft,
                            g = k.chartY - b.plotTop);
                            if (b.polar || !1 === l.options.clip || n.some(b => c.isDirectTouch || b.series.shouldShowTooltip(d, g)))
                                k = this.getLabel(),
                                f.style.width && !p || k.css({
            ...
            renderSplit(a, d) {
                function b(b, c, a, d, n=!0) {
                    a ? (c = S ? 0 : z,
                    b = l(b - d / 2, J.left, J.right - d - (f.outside ? W : 0))) : (c -= da,
                    b = n ? b - d - x : b + x,
                ...
                const f = this
                  , {chart: c, chart: {chartWidth: n, chartHeight: k, plotHeight: e, plotLeft: g, plotTop: h, pointer: q, scrollablePixelsY: r=0, scrollablePixelsX: p, scrollingContainer: {scrollLeft: t, scrollTop: v}={
                    scrollLeft: 0,
                    scrollTop: 0
                }, styledMode: G}, distance: x, options: E, options: {positioner: y}} = f
                ...
                a = a.slice(0, d.length + 1).reduce(function(c, a, n) {
                    if (!1 !== a && "" !== a) {
                        ...
                        var k = D ? f : n.series, q;
                        {
                            ...
                            G || (m.fill = E.backgroundColor,
                            m["stroke-width"] = null !== (q = E.borderWidth) && void 0 !== q ? q : 1),
                            m = O.label("", 0, 0, E[b ? "headerShape" : "shape"], void 0, void 0, E.useHTML).addClass(f.getClassName(r, !0, b)).attr(m).add(N));
                            m.isActive = !0;
                            m.attr({
                                text: a
                            });
                ...
                !y && a.some(b => {
                    ...
                    const {x: a, y: f} = b(c.anchorX, c.anchorY, c.point.isHeader, c.boxWidth, !1);
                    return m(c, {
                        target: f,
                        x: a
                    })
                ...
                a.forEach(function(b) {
                    ...
                    d || (f.outside && W + c < ca && (ca = W + c),
                    !d && f.outside && ca + a > L && (L = W + c))
                });
                a.forEach(function(b) {
                    const {x: c, anchorX: a, anchorY: d, pos: n, point: {isHeader: k}} = b
                      , e = {
            ...
            drawTracker() {
                if (this.shouldStickOnContact()) {
                    ...
                    if (d && b) {
                        ...
                        this.tracker ? this.tracker.attr(f) : (this.tracker = d.renderer.rect(f).addClass("highcharts-tracker").add(d),
    ...
    M(a, "Core/Series/Point.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Animation/AnimationUtilities.js"], a["Core/Defaults.js"], a["Core/Templating.js"], a["Core/Utilities.js"]], function(a, y, I, L, C) {
        const {animObject: x} = y
          , {defaultOptions: H} = I
          , {format: B} = L
          , {addEvent: u, defined: v, erase: l, extend: p, fireEvent: t, getNestedProperty: m, isArray: h, isFunction: g, isNumber: e, isObject: w, merge: E, objectEach: F, pick: d, syncTimeout: k, removeEvent: r, uniqueKey: q} = C;
        class G {
            constructor() {
            ...
            optionsToObject(b) {
                ...
                if (e(b) || null === b)
                    ...
                    for (!c && b.length > k && (a = typeof b[0],
                    "string" === a ? g.name = b[0] : "number" === a && (g.x = b[0]),
                    q++); r < k; )
                        c && "undefined" === typeof b[q] || (0 < d[r].indexOf(".") ? G.prototype.setNestedProperty(g, b[q], d[r]) : g[d[r]] = b[q]),
                        q++,
                        r++;
                else
                    "object" === typeof b && (g = b,
            ...
            pos(b, a=this.plotY) {
                if (!this.destroyed) {
                    ...
                    let h = 0
                      , q = 0;
                    if (e(c) && e(a))
                        return b && (h = k ? k.pos : d.plotLeft,
                        q = g ? g.pos : d.plotTop),
                        d.inverted && k && g ? [g.len - a + q, k.len - c + h] : [c + h, a + q]
                }
            }
            resolveColor() {
                const b = this.series;
                ...
                b.options.colorByPoint ? (a || (k = b.options.colors || b.chart.options.colors,
                c = k[b.colorCounter],
                k = k.length),
                a = b.colorCounter,
                b.colorCounter++,
                b.colorCounter === k && (b.colorCounter = 0)) : (a || (c = b.color),
                a = b.colorIndex);
            ...
            update(b, a, c, k) {
                function f() {
                    ...
                    f = null === n.y ? !f : f;
                    g && f && (n.graphic = g.destroy(),
                    delete n.hasMockGraphic);
                    w(b, !0) && (g && g.element && b && b.marker && "undefined" !== typeof b.marker.symbol && (n.graphic = g.destroy()),
                    b && b.dataLabels && n.dataLabel && (n.dataLabel = n.dataLabel.destroy()),
            ...
            select(b, a) {
                ...
                c.firePointEvent(b ? "select" : "unselect", {
                    ...
                    a || k.getSelectedPoints().forEach(function(b) {
                        const a = b.series;
                        b.selected && b !== c && (b.selected = b.options.selected = !1,
                        a.options.data[a.data.indexOf(b)] = b.options,
                        b.setState(k.hoverPoints && a.options.inactiveOtherPoints ? "inactive" : ""),
                        ...
                        if (b && r) {
                            ...
                            if (u)
                                if (E)
                                    ...
                                    h && (c.stateMarkerGraphic = E = w.renderer.symbol(h, u.x, u.y, u.width, u.height).add(c.markerGroup),
                                    E.currentSymbol = h);
                            !w.styledMode && E && "inactive" !== this.state && E.attr(c.pointAttribs(this, b))
                        }
                        E && (E[b && this.isInside ? "show" : "hide"](),
                        E.element.point = this,
                        E.addClass(this.getClassName(), !0))
                    }
                    g = g.halo;
                    u = (E = this.graphic || E) && E.visibility || "inherit";
                    g && g.size && E && "hidden" !== u && !this.isCluster ? (G || (c.halo = G = w.renderer.path().add(E.parentGroup)),
    ...
    M(a, "Core/Pointer.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y, I) {
        const {parse: x} = a
          , {charts: C, noop: z} = y
          , {addEvent: H, attr: B, css: u, defined: v, extend: l, find: p, fireEvent: t, isNumber: m, isObject: h, objectEach: g, offset: e, pick: w, splat: E} = I;
        class F {
            constructor(a, k) {
                this.lastValidTouch = {};
                this.pinchDown = [];
            ...
            destroy() {
                ...
                this.eventsToUnbind = [];
                y.chartCount || (F.unbindDocumentMouseUp && (F.unbindDocumentMouseUp = F.unbindDocumentMouseUp()),
            ...
            drag(a) {
                ...
                if (!v || !v.touch)
                    if (t < g ? t = g : t > g + b && (t = g + b),
                    w < l ? w = l : w > l + f && (w = l + f),
                    this.hasDragged = Math.sqrt(Math.pow(c - t, 2) + Math.pow(n - w, 2)),
                    10 < this.hasDragged) {
                        g = d.isInsidePlot(c - g, n - l, {
                            visiblePlotOnly: !0
                        });
                        const {shapeType: b, attrs: f} = this.getSelectionMarkerAttrs(t, w);
                        !d.hasCartesianSeries && !d.mapView || !this.zoomX && !this.zoomY || !g || p || v || (this.selectionMarker = v = d.renderer[b](),
                        v.attr({
            ...
            drop(a) {
                ...
                if (this.selectionMarker) {
                    const {x: k, y: b, width: f, height: c} = this.getSelectionBox(this.selectionMarker)
                      , n = {
                        originalEvent: a,
                        xAxis: [],
                        yAxis: [],
            ...
            getChartPosition() {
                ...
                a = a.offsetHeight;
                2 < g && 2 < a && (this.chartPosition.scaleX = k.width / g,
            ...
            getHoverData(a, k, e, g, l, b) {
                ...
                d.forEach(function(b) {
                    ...
                    h(c) && (b.boosted && b.boost && (c = b.boost.getPoint(c)),
                    f.push(c))
                })) : f.push(r));
                q = {
                    hoverPoint: r
            ...
            onContainerClick(a) {
                ...
                d.hoverPoint && e.firePointEvent("click", a)) : (l(a, this.getCoordinates(a)),
            ...
            onContainerMouseLeave(a) {
                ...
                a = this.normalize(a);
                d && a.relatedTarget && !this.inClass(a.relatedTarget, "highcharts-tooltip") && (d.pointer.reset(),
            ...
            pinchTranslateDirection(a, e, g, h, l, b, f, c) {
                ...
                g = E;
                g < w.min ? (g = w.min,
                O = !0) : g + G > w.max && (g = w.max - G,
                O = !0);
                O ? (J -= .8 * (J - f[k][0]),
                "number" === typeof N && (N -= .8 * (N - f[k][1])),
                e()) : f[k] = [J, N];
                t || (b[k] = E - p,
                b[r] = G);
                b = t ? 1 / F : F;
            ...
            reset(a, e) {
                ...
                if (a)
                    f && c && E(c).length && (f.refresh(c),
                    f.shared && b ? b.forEach(function(b) {
            ...
            runPointActions(a, e, g) {
                ...
                if (f && (g || f !== d.hoverPoint || k && k.isHidden)) {
                    ...
                    e && k && !k.isHidden && (g = k.getAnchor([{}], a),
            ...
            scaleGroups(a, e) {
                ...
                d.series.forEach(function(k) {
                    ...
                    k.group && (k.xAxis && k.xAxis.zoomEnabled || d.mapView) && (k.group.attr(g),
                    k.markerGroup && (k.markerGroup.attr(g),
            ...
            setDOMEvents() {
                ...
                for (; g && "BODY" !== g.tagName; )
                    this.eventsToUnbind.push(H(g, "scroll", () => {
                        delete this.chartPosition
                    }
                    )),
                    g = g.parentElement;
            ...
            touch(a, e) {
                ...
                let g, k;
                this.setHoverChartIndex();
                1 === a.touches.length ? (a = this.normalize(a),
                (k = d.isInsidePlot(a.chartX - d.plotLeft, a.chartY - d.plotTop, {
                    visiblePlotOnly: !0
                })) && !d.openMenu ? (e && this.runPointActions(a),
                "touchmove" === a.type && (e = this.pinchDown,
                g = e[0] ? 4 <= Math.sqrt(Math.pow(e[0].chartX - a.chartX, 2) + Math.pow(e[0].chartY - a.chartY, 2)) : !1),
                w(g, !0) && this.pinch(a)) : e && this.reset()) : 2 === a.touches.length && this.pinch(a)
            }
            touchSelect(a) {
    ...
    M(a, "Core/Legend/Legend.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Templating.js"], a["Core/Globals.js"], a["Core/Series/Point.js"], a["Core/Renderer/RendererUtilities.js"], a["Core/Utilities.js"]], function(a, y, I, L, C, z) {
        const {animObject: x, setAnimation: B} = a
          ...
          , {marginNames: v} = I
          , {distribute: l} = C
          , {addEvent: p, createElement: t, css: m, defined: h, discardElement: g, find: e, fireEvent: w, isNumber: E, merge: F, pick: d, relativeLength: k, stableSort: r, syncTimeout: q} = z;
        class G {
            constructor(b, a) {
                this.allItems = [];
            ...
            colorizeItem(b, a) {
                ...
                if (!this.chart.styledMode) {
                    ...
                    e && (n && e.isMarker && (h = b.pointAttribs(),
                    a || (h.stroke = h.fill = g)),
                    e.attr(h))
                }
            ...
            positionCheckboxes() {
                ...
                this.allItems.forEach(function(f) {
                    const e = f.checkbox;
                    let g;
                    e && (g = d + c + e.y + (this.scrollOffset || 0) + 3,
                    m(e, {
            ...
            renderItem(b) {
                ...
                this.baseline || (this.fontMetrics = e.fontMetrics(J),
                ...
                g.squareSymbol && (this.symbolWidth = d(g.symbolWidth, Math.max(this.symbolHeight, 16)),
            ...
            layoutItem(b) {
                ...
                e && this.itemX - c + a > m && (this.itemX = c,
                ...
                q.x = this.itemX;
                q.y = this.itemY;
                e ? this.itemX += a : (this.itemY += h + g + k,
            ...
            proximatePositions() {
                ...
                this.allItems.forEach(function(d) {
                    ...
                    var g = c;
                    let k;
                    d.yAxis && (d.xAxis.options.reversed && (g = !g),
                    d.points && (f = e(g ? d.points : d.points.slice(0).reverse(), function(b) {
                        return E(b.plotY)
                    })),
                    g = this.itemMarginTop + d.legendItem.label.getBBox().height + this.itemMarginBottom,
                    k = d.yAxis.top - b.plotTop,
                    d.visible ? (f = f ? f.plotY : d.yAxis.height,
                    f += k - .3 * g) : f = k + d.yAxis.height,
                    a.push({
                        target: f,
                        size: g,
                        item: d
            ...
            handleOverflow(b) {
                ...
                m && (k = Math.min(k, m));
                t.length = 0;
                b && 0 < k && b > k && !1 !== q.enabled ? (this.clipHeight = x = Math.max(k - 20 - this.titleHeight - l, 0),
                ...
                w.forEach( (b, a) => {
                    ...
                    a === w.length - 1 && b + c - t[d - 1] > x && b > t[d - 1] && (t.push(b),
                    N.pageIx = d);
                    b !== J && (J = b)
                }
                ),
                E || (E = a.clipRect = e.clipRect(0, l - 2, 9999, 0),
                a.contentGroup.clip(E)),
                v(x),
                O || (this.nav = O = e.g().attr({
                    zIndex: 1
                }).add(this.group),
    ...
    M(a, "Core/Legend/LegendSymbol.js", [a["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            a.lineMarker = function(a, B) {
                ...
                g && !1 !== g.enabled && v && (u = Math.min(L(g.radius, p), p),
                0 === this.symbol.indexOf("url") && (g = I(g, {
                    width: l,
                    height: l
                }),
                u = 0),
                B.symbol = B = t.symbol(this.symbol, v / 2 - u, a - u, 2 * u, 2 * u, x({
                    context: "legend"
                }, g)).addClass("highcharts-point").add(m),
                B.isMarker = !0)
            }
            ;
    ...
    M(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend/LegendSymbol.js"], a["Core/Series/Point.js"], a["Core/Series/SeriesDefaults.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function(a, y, I, L, C, z, H, B, u, v) {
        const {animObject: l, setAnimation: p} = a
          ...
          , {seriesTypes: w} = B
          , {arrayMax: x, arrayMin: F, clamp: d, correctFloat: k, defined: r, diffObjects: q, erase: G, error: b, extend: f, find: c, fireEvent: n, getClosestDistance: P, getNestedProperty: D, insertItem: K, isArray: X, isNumber: T, isString: Z, merge: V, objectEach: Y, pick: A, removeEvent: M, splat: ia, syncTimeout: ba} = v;
        class aa {
            constructor() {
                ...
                n(this, "bindAxes", null, function() {
                    (a.axisTypes || []).forEach(function(e) {
                        d[e].forEach(function(b) {
                            f = b.options;
                            if (A(c[e], 0) === b.index || "undefined" !== typeof c[e] && c[e] === f.id)
                                K(a, b.series),
                                a[e] = b,
                                b.isDirty = !0
                        });
            ...
            autoIncrement(b) {
                ...
                d && T(b) && (g *= b);
                c && (a = new f.Date(e),
                "day" === c ? f.set("Date", a, f.get("Date", a) + g) : "month" === c ? f.set("Month", a, f.get("Month", a) + g) : "year" === c && f.set("FullYear", a, f.get("FullYear", a) + g),
                g = a.getTime() - e);
                if (d && T(b))
                    return e + g;
                this.xIncrement = e + g;
            ...
            findPointIndex(b, a) {
                ...
                if (d)
                    ...
                    if (k = a => !a.touched && a.index === b.index,
                    g && g.matchByName ? k = a => !a.touched && a.name === b.name : this.options.relativeXValue && (k = a => !a.touched && a.options.x === b.x),
                    k = c(e, k),
                    !k)
                        return;
                k && (n = k && k.index,
            ...
            updateData(b, a) {
                ...
                b.forEach(function(b, a) {
                    ...
                    const m = h.x;
                    if (h.id || T(m)) {
                        if (h = this.findPointIndex(h, l),
                        -1 === h || "undefined" === typeof h ? e.push(b) : f[h] && b !== c.data[h] ? (f[h].update(b, !1, null, !1),
                        f[h].touched = !0,
                        g && (l = h + 1)) : f[h] && (f[h].touched = !0),
                ...
                if (n)
                    ...
                    !k || d && d.enabled ? m = !1 : (b.forEach(function(b, a) {
            ...
            generatePoints() {
                ...
                for (p = 0; p < g; p++)
                    w = k + p,
                    h ? (r = (new e).init(this, [c[p]].concat(ia(d[p]))),
                    r.dataGroup = this.groupMap[b + p],
                    r.dataGroup.options && (r.options = r.dataGroup.options,
                    f(r, r.dataGroup.options),
                    delete r.dataLabels)) : (r = t[w]) || "undefined" === typeof a[w] || (t[w] = r = (new e).init(this, a[w], c[p])),
                    r && (r.index = h ? b + p : w,
                    m[p] = r);
                this.options.keys = l;
                if (t && (g !== (q = t.length) || h))
            ...
            translate() {
                ...
                let w, v, u, x, D = Number.MAX_VALUE;
                for (w = 0; w < m; w++) {
                    const n = l[w]
                      , m = n.x;
                    ...
                    n.percentage = r(n.y) && J.total ? n.y / J.total * 100 : void 0,
                    n.stackY = R,
                    this.irregularWidths || J.setOffset(this.pointXOffset || 0, this.barW || 0, void 0, void 0, void 0, this.xAxis)));
                    n.yBottom = r(O) ? d(h.translate(O, !1, !0, !1, !0), -1E5, 1E5) : void 0;
                    this.dataModify && (R = this.dataModify.modifyValue(R, w));
                    let N;
                    T(R) && void 0 !== n.plotX && (N = h.translate(R, !1, !0, !1, !0),
                    ...
                    n.isNull || !1 === n.visible || ("undefined" !== typeof u && (D = Math.min(D, Math.abs(v - u))),
                    u = v);
            ...
            animate(b) {
                ...
                if (b && c)
                    e = this.getClipBox(),
                    k ? k.attr("height", e.height) : (e.width = 0,
                    f && (e.x = a.plotHeight),
            ...
            afterAnimate() {
                ...
                Y(this.chart.sharedClips, (b, a, c) => {
                    b && !this.chart.container.querySelector(`[clip-path="url(#${b.id})"]`) && (b.destroy(),
                    delete c[a])
                }
                );
                ...
                if (!1 !== e.enabled || this._hasPointMarkers)
                    for (h = 0; h < b.length; h++) {
                        ...
                        if ((n && "undefined" === typeof t.enabled || t.enabled) && !l.isNull && !1 !== l.visible) {
                            ...
                            !m && f && (0 < (r.width || 0) || l.hasImage) && (l.graphic = m = a.renderer.symbol(b, r.x, r.y, r.width, r.height, p ? t : e).add(g),
                            this.enabledDataSorting && a.hasRendered && (m.attr({
                                x: l.startXPos
                            }),
                            q = "animate"));
                            m && "animate" === q && m[f ? "show" : "hide"](f).animate(r);
                            if (m)
                                if (t = this.pointAttribs(l, c || !l.selected ? void 0 : "select"),
                                c)
                                    d && m.css({
                                        fill: t.fill
                                    });
            ...
            markerAttribs(b, a) {
                ...
                k = A(a && a.radius, d && d.radius, k && k + (d && d.radiusPlus || 0)));
            ...
            destroy(b) {
                ...
                Y(a, function(b, a) {
                    b instanceof u && !b.survive && (g = d && "group" === a ? "hide" : "destroy",
                    b[g]())
                });
            ...
            applyZones() {
                ...
                f.length && (g || k) && h && "undefined" !== typeof h.min ? (t = h.reversed,
                w = h.horiz,
                ...
                this.clips = e) : b.visible && (g && g.show(),
                k && k.show())
            }
            plotGroup(b, a, c, d, f) {
                let e = this[b];
            ...
            searchKDTree(b, a, c) {
                function d(b, a, c, n) {
                    ...
                    a[p] && (p = d(b, a[p], c + 1, n),
                    m = p[k] < m[k] ? p : h);
                    a[q] && Math.sqrt(l * l) < m[k] && (b = d(b, a[q], c + 1, n),
                    m = b[k] < m[k] ? b : m);
                    return m
                }
                const f = this
            ...
            update(a, c) {
                ...
                const p = {};
                let r, t = ["colorIndex", "eventOptions", "navigatorSeries", "symbolIndex", "baseSeries"], v = a.type || g.type || e.options.chart.type;
                ...
                v = v || k;
                u && (t.push("data", "isDirtyData", "points", "processedData", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "_hasPointLabels", "clips", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"),
                !1 !== a.visible && t.push("area", "graph"),
                d.parallelArrays.forEach(function(b) {
                    t.push(b + "Data")
                }),
                a.data && (a.dataSorting && f(d.options.dataSorting, a.dataSorting),
                ...
                if (u && this.points) {
                    ...
                    for (const b of this.points)
                        ...
                        !1 === a.showInLegend && b.legendItem && e.legend.destroyItem(b))
                }
                d.initialType = k;
                e.linkSeries();
            ...
            setState(b, a) {
                ...
                !c.chart.styledMode)) {
                    if (g[b] && !1 === g[b].enabled)
                        return;
                    b && (h = g[b].lineWidth || h + (g[b].lineWidthPlus || 0),
                    l = A(g[b].opacity, l));
                    if (f && !f.dashstyle && T(h))
                        for (d = {
                            "stroke-width": h
                        },
                        f.animate(d, k); c["zone-graph-" + n]; )
                            c["zone-graph-" + n].animate(d, k),
                            n += 1;
    ...
    M(a, "Core/Chart/Chart.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Defaults.js"], a["Core/Templating.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Time.js"], a["Core/Utilities.js"], a["Core/Renderer/HTML/AST.js"]], function(a, y, I, L, C, z, H, B, u, v, l, p, t) {
        const {animate: m, animObject: h, setAnimation: g} = a
          ...
          , {seriesTypes: b} = u
          , {addEvent: f, attr: c, createElement: n, css: P, defined: D, diffObjects: K, discardElement: X, erase: T, error: Z, extend: V, find: Y, fireEvent: A, getStyle: M, isArray: ia, isNumber: ba, isObject: aa, isString: J, merge: N, objectEach: O, pick: S, pInt: W, relativeLength: ha, removeEvent: da, splat: fa, syncTimeout: ka, uniqueKey: ca} = p;
        class ea {
            static chart(b, a, c) {
                return new ea(b,a,c)
            }
            ...
            getArgs(b, a, c) {
                J(b) || b.nodeName ? (this.renderTo = b,
                ...
                if (c)
                    for (let f = a, e = c.length; f < e; ++f)
                        if (a = c[f])
                            ...
                            a.options.isInternal || (d[f] = a.options,
                            b[f] = a.userOptions)
            }
            isInsidePlot(b, a, c={}) {
                const {inverted: d, plotBox: f, plotLeft: e, plotTop: g, scrollablePlotBox: k} = this;
                var h = 0;
                let n = 0;
                c.visiblePlotOnly && this.scrollingContainer && ({scrollLeft: h, scrollTop: n} = this.scrollingContainer);
                const l = c.series
                ...
                c >= Math.max(n + g, h.pos) && c <= Math.min(n + g + m.height, h.pos + h.len) || (b.isInsidePlot = !1));
            ...
            redraw(b) {
                ...
                c.forEach(function(b) {
                    ...
                    p = !0) : e && (e.labelFormatter || e.labelFormat) && (p = !0));
                    b.isDirtyData && A(b, "updatedData")
                });
                p && f && f.options.enabled && (f.render(),
            ...
            temporaryDisplay(b) {
                ...
                if (b)
                    for (; a && a.style; )
                        a.hcOrigStyle && (P(a, a.hcOrigStyle),
                        delete a.hcOrigStyle),
                        a.hcOrigDetached && (k.body.removeChild(a),
                        a.hcOrigDetached = !1),
                        a = a.parentNode;
                else
                    for (; a && a.style; ) {
                        k.body.contains(a) || a.parentNode || (a.hcOrigDetached = !0,
            ...
            setReflow() {
                ...
                ;
                "function" === typeof ResizeObserver ? (new ResizeObserver(a)).observe(b.renderTo) : (a = f(G, "resize", a),
                f(this, "destroy", a))
            }
            setSize(b, a, c) {
                const d = this
            ...
            drawChartBox() {
                ...
                w || (this.chartBackground = w = a.rect().addClass("highcharts-background").add(),
                E = "attr");
                if (f)
                    x = D = w.strokeWidth();
                else {
                ...
                E = "animate";
                v || (E = "attr",
                this.plotBackground = v = a.rect().addClass("highcharts-plot-background").add());
                v[E](p);
                f || (v.attr({
                    fill: k || "none"
                }).shadow(b.plotShadow),
                h && (e ? (h !== e.attr("href") && e.attr("href", h),
                e.animate(p)) : this.plotBGImage = a.image(h, n, l, m, q).add()));
                r ? r.animate({
                    width: t.width,
                    height: t.height
                ...
                E = "animate";
                u || (E = "attr",
                this.plotBorder = u = a.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                f || u.attr({
            ...
            update(b, a, c, d) {
                ...
                b.time && (this.time === w && (this.time = new l(b.time)),
                N(!0, f.options.time, b.time));
                O(b, function(a, c) {
                    if (f[c] && "function" === typeof f[c].update)
                        f[c].update(a, !1);
                    else if ("function" === typeof f[e[c]])
                        f[e[c]](a);
                    else
                        "colors" !== c && -1 === f.collectionsWithUpdate.indexOf(c) && N(!0, f.options[c], b[c]);
                    ...
                    a.forEach(function(a) {
                        if (a.options.panningEnabled && !a.options.isInternal) {
                            ...
                            !l || a.isXAxis || t && !t.isDirty || a.series.forEach(function(b) {
                                ...
                                ba(a.dataMin) && ba(a.dataMax) && (t.startMin = Math.min(S(b.options.threshold, Infinity), a.dataMin, t.startMin),
                                t.startMax = Math.max(S(b.options.threshold, -Infinity), a.dataMax, t.startMax))
                            });
                            ...
                            0 < n && (q = p,
                            h -= n),
                            a.series.length && h !== m.min && q !== m.max && h >= l && q <= p && (a.setExtremes(h, q, !1, !1, {
                                trigger: "pan"
                            }),
                            !c.resetZoomButton && h !== l && q !== p && e.match("y") && (c.showResetZoom(),
                            a.displayBtn = !1),
                            g = !0),
                            f[d] = k)
                        }
    ...
    M(a, "Extensions/ScrollablePlotArea.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Series/Series.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function(a, y, I, L, C, z) {
        ...
        B(I, "afterSetChartSize", function(a) {
            ...
            if (!this.renderer.forExport) {
                if (h) {
                    ...
                    m && (this.scrollablePixelsY = h = Math.max(0, m - this.chartHeight),
                    v(h) && (this.scrollablePlotBox = this.renderer.scrollablePlotBox = l(this.plotBox),
                    this.plotBox.height = this.plotHeight += h,
                    this.inverted ? this.clipBox.width += h : this.clipBox.height += h,
                    g = {
                        2: {
                            name: "bottom",
                            value: h
        ...
        I.prototype.moveFixedElements = function() {
            let a = this.container, l = this.fixedRenderer, h = ".highcharts-breadcrumbs-group .highcharts-contextbutton .highcharts-credits .highcharts-legend .highcharts-legend-checkbox .highcharts-navigator-series .highcharts-navigator-xaxis .highcharts-navigator-yaxis .highcharts-navigator .highcharts-reset-zoom .highcharts-drillup-button .highcharts-scrollbar .highcharts-subtitle .highcharts-title".split(" "), g;
        ...
        I.prototype.applyFixed = function() {
            ...
            this.fixedRenderer = l = new g(this.fixedDiv,this.chartWidth,this.chartHeight,this.options.chart.style),
            this.scrollableMask = l.path().attr({
            ...
            B(this, "afterLayOutTitles", this.moveFixedElements)) : this.fixedRenderer.setSize(this.chartWidth, this.chartHeight);
            ...
            a && (h.scrollPositionX && (this.scrollingContainer.scrollLeft = this.scrollablePixelsX * h.scrollPositionX),
            h.scrollPositionY && (this.scrollingContainer.scrollTop = this.scrollablePixelsY * h.scrollPositionY));
            g = this.axisOffset;
        ...
        class v {
            ...
            render(a) {
                ...
                this.label ? this.label.attr({
                    text: m,
                    visibility: "hidden"
                }) : (this.label = l.renderer.label(m, null, void 0, t.shape, void 0, void 0, t.useHTML, !1, "stack-labels"),
                m = {
                    r: t.borderRadius || 0,
                    text: m,
                ...
                l.styledMode || (m.fill = t.backgroundColor,
            ...
            setOffset(a, p, t, m, h, g) {
                const {alignOptions: e, axis: l, label: v, options: x, textAlign: d} = this
                  , k = l.chart;
                t = this.getStackBox({
                    xOffset: a,
                    width: p,
    ...
    M(a, "Core/Axis/Stacking/StackingAxis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Axis/Stacking/StackItem.js"], a["Core/Utilities.js"]], function(a, y, I, L, C) {
        ...
        function t(b) {
            ...
            if (f && (!0 === this.visible || !1 === a.options.chart.ignoreHiddenSeries)) {
                ...
                for (G = 0; G < l; G++) {
                    ...
                    u[z] || (u[z] = {});
                    u[z][F] || (x[z] && x[z][F] ? (u[z][F] = x[z][F],
                    u[z][F].total = null) : u[z][F] = new L(a,a.options.stackLabels,!!E,F,m));
                    z = u[z][F];
                    null !== B ? (z.points[C] = z.points[this.index] = [q(z.cumulative, r)],
                    w(z.cumulative) || (z.base = C),
                    z.touched = a.stacking.stacksTouched,
                    0 < y.index && !1 === this.singleStacks && (z.points[C][0] = z.points[this.index + "," + F + ",0"][0])) : z.points[C] = z.points[this.index] = null;
                    "percent" === f ? (E = E ? b : t,
                    v && u[E] && u[E][F] ? (E = u[E][F],
                    z.total = E.total = Math.max(E.total, z.total) + Math.abs(B) || 0) : z.total = e(z.total + (Math.abs(B) || 0))) : "group" === f ? (d(B) && (B = B[0]),
                    null !== B && (z.total = (z.total || 0) + 1)) : z.total = e(z.total + (B || 0));
                    z.cumulative = "group" === f ? (z.total || 1) - 1 : e(q(z.cumulative, r) + (B || 0));
                    null !== B && (z.points[C].push(z.cumulative),
                    h[G] = z.cumulative,
                    z.hasValidPoints = !0)
                }
        ...
        const {getDeferredAnimation: m} = a
          , {series: {prototype: h}} = I
          , {addEvent: g, correctFloat: e, defined: w, destroyObjectProperties: E, fireEvent: F, isArray: d, isNumber: k, objectEach: r, pick: q} = C;
        class G {
            constructor(b) {
                this.oldStacks = {};
                this.stacks = {};
            ...
            resetStacks() {
                r(this.stacks, b => {
                    r(b, (a, d) => {
                        k(a.touched) && a.touched < this.stacksTouched ? (a.destroy(),
                        delete b[d]) : (a.total = null,
                        a.cumulative = null)
                    }
                    )
                }
        ...
        (function(b) {
            ...
            b.compose = function(b, c, d) {
                C.pushUnique(a, b) && (g(b, "init", B),
                g(b, "destroy", H));
                C.pushUnique(a, c) && (c.prototype.getStacks = x);
                C.pushUnique(a, d) && (b = d.prototype,
        ...
        class z extends a {
            ...
            drawGraph() {
                ...
                l.forEach(function(l, t) {
                    ...
                    h ? (h.endX = a.preventGraphAnimation ? null : u.xMap,
                    h.animate({
                        d: u
                    ...
                    l[3] ? m.dashstyle = l[3] : "square" !== x.linecap && (m["stroke-linecap"] = m["stroke-linejoin"] = "round"),
            ...
            getGraphPath(a, B, u) {
                ...
                a.forEach(function(e, g) {
                    ...
                    k && !x(B) && 0 < g ? m = !l.connectNulls : k && !B ? m = !0 : (0 === g || m ? g = [["M", e.plotX, e.plotY]] : v.getPointSpline ? g = [v.getPointSpline(a, e, g)] : h ? (g = 1 === h ? [["L", d.plotX, F]] : 2 === h ? [["L", (d.plotX + w) / 2, d.plotY], ["L", (d.plotX + w) / 2, F]] : [["L", w, d.plotY]],
                    g.push(["L", w, F])) : g = [["L", w, F]],
                    t.push(e.x),
                    h && (t.push(e.x),
                    2 === h && t.push(e.x)),
                    p.push.apply(p, g),
        ...
        class u extends x {
            ...
            drawGraph() {
                ...
                t.forEach(function(m) {
                    ...
                    e ? (e.endX = a.preventGraphAnimation ? null : l.xMap,
                    e.animate({
                        d: l
                    })) : (g.zIndex = 0,
                    e = a[h] = a.chart.renderer.path(l).addClass(m[1]).add(a.group),
                    e.isArea = !0);
                    a.chart.styledMode || (m[3] ? g.fill = m[3] : (g.fill = m[2],
                    g["fill-opacity"] = B(p.fillOpacity, .75)));
                    e[t](g);
                    e.startX = l.xMap;
        ...
        class z extends x {
            ...
            getPointSpline(a, x, u) {
                ...
                if (p && !p.isNull && !1 !== p.doCurve && !x.isCliff && u && !u.isNull && !1 !== u.doCurve && !x.isCliff) {
                    ...
                    m += e;
                    h += e;
                    m > a && m > l ? (m = Math.max(a, l),
                    h = 2 * l - m) : m < a && m < l && (m = Math.min(a, l),
                    h = 2 * l - m);
                    h > u && h > l ? (h = Math.max(u, l),
                    m = 2 * l - h) : h < u && h < l && (h = Math.min(u, l),
                    m = 2 * l - h);
                    x.rightContX = g;
                    x.rightContY = h
                }
    ...
    M(a, "Series/AreaSpline/AreaSplineSeries.js", [a["Series/Spline/SplineSeries.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, y, I) {
        const {area: x, area: {prototype: C}} = y.seriesTypes
          , {extend: z, merge: H} = I;
        class B extends a {
            constructor() {
                super(...arguments);
    ...
    M(a, "Series/Column/ColumnSeries.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"], a["Series/Column/ColumnSeriesDefaults.js"], a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, y, I, L, C, z, H) {
        const {animObject: x} = a
          , {parse: u} = y
          , {hasTouch: v, noop: l} = L
          , {clamp: p, defined: t, extend: m, fireEvent: h, isArray: g, isNumber: e, merge: w, pick: E, objectEach: F} = H;
        class d extends C {
            constructor() {
                super(...arguments);
            ...
            animate(a) {
                ...
                d.clipBox && d.setClip(),
                d.group.attr(c)) : (h = Number(d.group.attr(k)),
                d.group.animate({
                    scaleY: 1
                }, m(x(d.options.animation), {
                    step: function(b, a) {
                        d.group && (c[k] = h + a.pos * (g - h),
                        d.group.attr(c))
                    }
                })))
            }
            ...
            getColumnMetrics() {
                ...
                !1 === d.grouping ? h = 1 : a.chart.series.forEach(function(b) {
                    const d = b.yAxis
                      , e = b.options;
                    let k;
                    b.type !== a.type || !b.visible && a.chart.options.chart.ignoreHiddenSeries || g.len !== d.len || g.pos !== d.pos || (e.stacking && "group" !== e.stacking ? (c = b.stackKey,
                    "undefined" === typeof f[c] && (f[c] = h++),
                    k = f[c]) : !1 !== e.grouping && (k = h++),
                    b.columnIndex = k)
                });
            ...
            crispCol(a, d, e, g) {
                var b = this.borderWidth
                  , f = -(b % 2 ? .5 : 0);
                b = b % 2 ? .5 : 1;
                this.options.crisp && (e = Math.round(a + e) + f,
                a = Math.round(a) + f,
                e -= a);
                g = Math.round(d + g) + b;
                f = .5 >= Math.abs(d) && .5 < g;
                ...
                if (!e.isNull && 1 < h.columnCount) {
                    ...
                    F(this.yAxis.stacking && this.yAxis.stacking.stacks, a => {
                        if ("number" === typeof e.x) {
                            ...
                            d && (a = d.points[this.index],
                            b ? (a && (c = k),
                            d.hasValidPoints && (f ? k++ : k--)) : g(a) && (a = Object.keys(d.points).filter(b => !b.match(",") && d.points[b] && 1 < d.points[b].length).map(parseFloat).sort( (b, a) => a - b),
            ...
            translate() {
                ...
                a.points.forEach(function(k) {
                    ...
                    e(c) && e(x) && k.y === c && x <= c && (f.min || 0) < c && (u !== x || (f.max || 0) <= c) && (q = !q,
            ...
            pointAttribs(a, d) {
                ...
                k = a.options.color || c && (c.color || a.nonZonedColor) || this.color,
                c && (h = c.borderColor || h,
                g = c.dashStyle || g,
                l = c.borderWidth || l));
                d && a && (a = w(e.states[d], a.options.states && a.options.states[d] || {}),
                d = a.brightness,
                k = a.color || "undefined" !== typeof d && u(k).brighten(a.brightness).get() || k,
                h = a[b] || h,
                l = a[f] || l,
                g = a.dashStyle || g,
                m = E(a.opacity, m));
            ...
            drawPoints(a=this.points) {
                ...
                a.forEach(function(a) {
                    ...
                    if (e(a.plotY) && null !== a.y) {
                        ...
                        h && (h.addClass(a.getClassName(), !0),
                        h.attr({
                            visibility: a.visible ? "inherit" : "hidden"
                        }))
                    } else
                        h && (a.graphic = h.destroy())
                })
            }
            drawTracker(a=this.points) {
                const d = this
                  ...
                  , b = function(a) {
                    ...
                    "undefined" !== typeof b && d.options.enableMouseTracking && (k.isDirectTouch = !0,
                    b.onMouseOver(a))
                };
                let f;
                a.forEach(function(a) {
    ...
    M(a, "Core/Series/DataLabel.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Templating.js"], a["Core/Utilities.js"]], function(a, y, I) {
        const {getDeferredAnimation: x} = a
          , {format: C} = y
          , {defined: z, extend: H, fireEvent: B, isArray: u, isString: v, merge: l, objectEach: p, pick: t, splat: m} = I;
        var h;
        (function(a) {
            function e(a, d, c, e, g) {
                ...
                if (f && h) {
                    ...
                    k && this.xAxis && !p && this.setDataLabelStartPos(a, d, g, l, r),
                    d[g ? "attr" : "animate"](r)) : (k && this.xAxis && !p && this.setDataLabelStartPos(a, d, g, l, e),
                    d.align(c, void 0, e),
                    r = d.alignAttr);
                    if (p && 0 <= e.height)
            ...
            function F(a) {
                ...
                !b && c && (this.visible && c.show(),
                this.options.animation ? c.animate({
                    opacity: 1
                }, a) : c.attr({
                    opacity: 1
                }));
                    ...
                    a.forEach(a => {
                        ...
                        A.forEach( (b, f) => {
                            ...
                            if (m) {
                                ...
                                A = b.rotation;
                                e.styledMode || (q.color = t(b.color, q.color, v(d.color) ? d.color : void 0, "#000000"),
                                "contrast" === q.color ? (a.contrastColor = h.getContrast(a.color || d.color),
                                q.color = !z(x) && b.inside || 0 > (x || 0) || k.stacking ? a.contrastColor : E) : delete a.contrastColor,
                            ...
                            !w || m && z(F) && !!w.div === !!b.useHTML && (w.rotation && b.rotation || w.rotation === b.rotation) || (w = void 0,
                            u = !0,
                            n && a.connector && (a.connector = a.connector.destroy(),
                            a.connectors && (1 === a.connectors.length ? delete a.connectors : delete a.connectors[f])));
                            m && z(F) && (w ? r.text = F : (w = A ? h.text(F, 0, 0, b.useHTML).addClass("highcharts-data-label") : h.label(F, 0, 0, b.shape, void 0, void 0, b.useHTML, void 0, "data-label")) && w.addClass(" highcharts-data-label-color-" + a.colorIndex + " " + (b.className || "") + (b.useHTML ? " highcharts-tracker" : "")),
                            w && (w.options = b,
                            w.attr(r),
                            e.styledMode || w.css(q).shadow(b.shadow),
                            (m = b[a.formatPrefix + "TextPath"] || b.textPath) && !b.useHTML && (w.setTextPath((null === (l = a.getDataLabelPath) || void 0 === l ? void 0 : l.call(a, w)) || a.graphic, m),
                            a.dataLabelPath && !m.enabled && (a.dataLabelPath = a.dataLabelPath.destroy())),
                            w.added || w.add(y),
                        ...
                        for (b = c.length; b--; )
                            c[b].isActive ? c[b].isActive = !1 : (c[b].destroy(),
                            c.splice(b, 1));
                        a.dataLabel = c[0];
                        a.dataLabels = c
                    }
            ...
            function k(a, d, c, e, g, k) {
                ...
                p = (c.x || 0) + l;
                0 > p && ("right" === f && 0 <= m ? (d.align = "left",
                d.inside = !0) : m -= p,
                q = !0);
                p = (c.x || 0) + e.width - l;
                p > b.plotWidth && ("left" === f && 0 >= m ? (d.align = "right",
                d.inside = !0) : m += b.plotWidth - p,
                q = !0);
                p = c.y + l;
                0 > p && ("bottom" === h && 0 <= n ? (d.verticalAlign = "top",
                d.inside = !0) : n -= p,
                q = !0);
                p = (c.y || 0) + e.height - l;
                p > b.plotHeight && ("top" === h && 0 >= n ? (d.verticalAlign = "bottom",
                d.inside = !0) : n += b.plotHeight - p,
                q = !0);
                q && (d.x = m,
                d.y = n,
                a.placed = !k,
            ...
            a.compose = function(a) {
                I.pushUnique(y, a) && (a = a.prototype,
    ...
    M(a, "Series/Pie/PiePoint.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function(a, y, I) {
        const {setAnimation: x} = a
          , {addEvent: C, defined: z, extend: H, isNumber: B, pick: u, relativeLength: v} = I;
        class l extends y {
            constructor() {
                super(...arguments);
        ...
        H(l.prototype, {
            connectorShapes: {
                ...
                crookedLine: function(a, l, m) {
                    ...
                    l = "left" === a.alignment;
                    const {x: r, y: q} = a;
                    m.crookDistance ? (a = v(m.crookDistance, 1),
                    a = l ? e + u + (d + k - e - u) * (1 - a) : k + (e - u) * a) : a = e + (p - q) * Math.tan((this.angle || 0) - Math.PI / 2);
                    m = [["M", r, q]];
        ...
        class e extends z {
            ...
            drawEmpty() {
                const a = this.startAngleRad
                  ...
                  , g = this.options;
                let d, k;
                0 === this.total && this.center ? (d = this.center[0],
                k = this.center[1],
                this.graph || (this.graph = this.chart.renderer.arc(d, k, this.center[1] / 2, 0, a, e).addClass("highcharts-empty-series").add(this.group)),
                this.graph.attr({
            ...
            redrawPoints() {
                ...
                a.points.forEach(function(l) {
                    const q = {};
                    d = l.graphic;
                    !l.isNull && d ? (h = l.shapeArgs,
                    g = l.getTranslate(),
                    e.styledMode || (k = a.pointAttribs(l, l.selected && "select")),
                    l.delayedRendering ? (d.setRadialReference(a.center).attr(h).attr(g),
                    e.styledMode || d.attr(k).attr({
                        "stroke-linejoin": "round"
                    }),
                    l.delayedRendering = !1) : (d.setRadialReference(a.center),
    ...
    M(a, "Series/Pie/PieDataLabel.js", [a["Core/Series/DataLabel.js"], a["Core/Globals.js"], a["Core/Renderer/RendererUtilities.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, y, I, L, C) {
        const {noop: x} = y
          , {distribute: H} = I
          , {series: B} = L
          , {arrayMax: u, clamp: v, defined: l, merge: p, pick: t, relativeLength: m} = C;
        var h;
        (function(g) {
            function e() {
                const a = this
                ...
                d.forEach(function(a) {
                    ...
                    !l(g.style.width) && !l(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > m && (a.dataLabel.css({
                ...
                y.forEach( (d, k) => {
                    ...
                    if (m) {
                        ...
                        if (0 < a.maxLabelDistance) {
                            ...
                            d.forEach(function(a) {
                                0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, x - v - a.labelDistance),
                                a.bottom = Math.min(x + v + a.labelDistance, e.plotHeight),
                        ...
                        for (W = 0; W < m; W++) {
                            ...
                            O = r = M.natural.y;
                            n && l(C.distributeBox) && ("undefined" === typeof C.distributeBox.pos ? S = "hidden" : (J = C.distributeBox.size,
                            ...
                            M && (M.computed.x = N,
                            M.computed.y = O);
                            t(g.crop, !0) && (L = I.getBBox().width,
                            r = null,
                            N - L < b && 1 === k ? (r = Math.round(L - N + b),
                            z[3] = Math.max(r, z[3])) : N + L > f - b && 0 === k && (r = Math.round(N + L - f + b),
                            z[1] = Math.max(r, z[1])),
                            0 > O - J / 2 ? z[0] = Math.max(Math.round(-O + J / 2), z[0]) : O + J / 2 > c && (z[2] = Math.max(Math.round(O + J / 2 - c), z[2])),
                            I.sideOverflow = r)
                        }
                    }
                }
                ),
                0 === u(z) || this.verifyDataLabelOverflow(z)) && (this.placeDataLabels(),
                this.points.forEach(function(b) {
                    ...
                    if (A = t(U.connectorWidth, 1)) {
                        ...
                        if ((I = b.dataLabel) && I._pos && b.visible && 0 < b.labelDistance) {
                            ...
                            if (c = !E)
                                b.connector = E = e.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + b.colorIndex + (b.className ? " " + b.className : "")).add(a.dataLabelsGroup),
                                e.styledMode || E.attr({
                                    "stroke-width": A,
            ...
            function h() {
                this.points.forEach(function(a) {
                    let d = a.dataLabel, e;
                    d && a.visible && ((e = d._pos) ? (d.sideOverflow && (d._attr.width = Math.max(d.getBBox().width - d.sideOverflow, 0),
                    d.css({
            ...
            function y(a) {
                ...
                c || (null !== g[0] ? f = Math.max(d[2] - Math.max(a[1], a[3]), b) : (f = Math.max(d[2] - a[1] - a[3], b),
                d[0] += (a[3] - a[1]) / 2),
                null !== g[1] ? f = v(f, b, d[2] - Math.max(a[0], a[2])) : (f = v(f, b, d[2] - a[0] - a[2]),
                d[1] += (a[0] - a[2]) / 2),
                f < d[2] ? (d[2] = f,
                d[3] = Math.min(e.thickness ? Math.max(0, f - 2 * e.thickness) : Math.max(0, m(e.innerSize || 0, f)), f),
                this.translate(d),
            ...
            g.compose = function(g) {
                a.compose(B);
                C.pushUnique(z, g) && (g = g.prototype,
    ...
    M(a, "Extensions/OverlappingDataLabels.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"]], function(a, y) {
        function x(a, l) {
            let p, t = !1;
            a && (p = a.newOpacity,
            a.oldOpacity !== p && (a.alignAttr && a.placed ? (a[p ? "removeClass" : "addClass"]("highcharts-data-label-hidden"),
            t = !0,
            ...
            (this.series || []).forEach(function(p) {
                ...
                p.visible && (!1 !== t.enabled || p._hasPointLabels) && (t = m => m.forEach(h => {
                    h.visible && (z(h.dataLabels) ? h.dataLabels : h.dataLabel ? [h.dataLabel] : []).forEach(function(g) {
                        ...
                        e.allowOverlap ? (g.oldOpacity = g.opacity,
                        g.newOpacity = 1,
                        x(g, a)) : l.push(g)
                    })
                }
        ...
        a.prototype.hideOverlappingLabels = function(a) {
            ...
            for (h = 0; h < p; h++)
                for (e = (v = a[h]) && v.absoluteBox,
                m = h + 1; m < p; ++m)
                    w = (g = a[m]) && g.absoluteBox,
                    !e || !w || v === g || 0 === v.newOpacity || 0 === g.newOpacity || "hidden" === v.visibility || "hidden" === g.visibility || w.x >= e.x + e.width || w.x + w.width <= e.x || w.y >= e.y + e.height || w.y + w.height <= e.y || ((v.labelrank < g.labelrank ? v : g).newOpacity = 0);
            a.forEach(function(a) {
                x(a, l) && (u = !0)
            });
    ...
    M(a, "Extensions/BorderRadius.js", [a["Core/Defaults.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]], function(a, y, I, L, C, z) {
        ...
        ({seriesTypes: a} = I);
        const {addEvent: B, extend: u, isObject: v, merge: l, relativeLength: p} = z
          , t = {
            radius: 0,
            scope: "stack",
            where: void 0
        ...
        if (-1 === L.symbolCustomAttribs.indexOf("borderRadius")) {
                ...
                for (g = a.length - 1; g--; ) {
                    {
                        ...
                        var b = g
                          ...
                          , n = m[b + 1];
                        "Z" === n[0] && (n = m[0]);
                        "M" !== c[0] && "L" !== c[0] || "A" !== n[0] ? "A" !== c[0] || "M" !== n[0] && "L" !== n[0] || (k = n,
                        h = c) : (k = c,
                        h = n,
                        e = !0);
                        if (k && h && h.params) {
                            ...
                            k[1] = g + u * Math.cos(a),
                            k[2] = l + u * Math.sin(a),
                            m.splice(b + 1, 0, ["A", f, f, 0, 0, 1, g + c * Math.cos(n.start), l + c * Math.sin(n.start)])) : (n.end = d - w,
                            h[6] = g + c * Math.cos(n.end),
                            h[7] = l + c * Math.sin(n.end),
                            m.splice(b + 1, 0, ["A", f, f, 0, 0, 1, g + u * Math.cos(d), l + u * Math.sin(d)]));
            ...
            C.prototype.symbols.roundedRect = function(a, h, l, m, d={}) {
                ...
                m < d - n && (n = Math.sqrt(Math.pow(d, 2) - Math.pow(d - n - m, 2)),
                w[0] = v[0] = a + l - d + n,
                x[0] = Math.min(w[0], x[0]),
                y[0] = Math.max(v[0], y[0]),
                z[0] = B[0] = a + d - n,
                w[1] = B[1] = h + m);
                u && (n = Math.sqrt(Math.pow(c, 2) - Math.pow(c - u, 2)),
                x[0] += n,
                y[0] -= n,
                v[1] = z[1] = h + m - c + u);
                m < c - u && (m = Math.sqrt(Math.pow(c, 2) - Math.pow(c - u - m, 2)),
                w[0] = v[0] = a + l - c + m,
                ...
                if (this.options.borderRadius && (!this.chart.is3d || !this.chart.is3d())) {
                    ...
                    for (const k of this.points)
                        ...
                        "roundedRect" === k.shapeType && h) {
                            ...
                            var l = c
                              , d = f;
                            "stack" === a.scope && k.stackTotal && (l = r.translate(q ? 100 : k.stackTotal, !1, !0, !1, !0),
    ...
    M(a, "Core/Responsive.js", [a["Core/Utilities.js"]], function(a) {
        ...
        (function(u) {
            ...
            function l(a, l) {
                ...
                e = e.toString() || void 0;
                e !== (g && g.ruleIds) && (g && this.update(g.undoOptions, a, !0),
                e ? (g = x(l, this.options, !0, this.collectionsWithUpdate),
