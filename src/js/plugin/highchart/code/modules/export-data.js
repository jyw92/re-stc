...
(function(a) {
    ...
    module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function(b) {
        a(b);
        a.Highcharts = b;
        return a
    ...
    function b(a, b, e, p) {
        a.hasOwnProperty(b) || (a[b] = p.apply(null, e),
    ...
    b(a, "Extensions/ExportData/ExportData.js", [a["Core/Renderer/HTML/AST.js"], a["Extensions/ExportData/ExportDataDefaults.js"], a["Core/Globals.js"], a["Core/Defaults.js"], a["Extensions/DownloadURL.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function(a, b, e, p, n, C, r) {
        function c() {
            ...
            O(P(a, "text/csv") || "data:text/csv,\ufeff" + encodeURIComponent(a), this.getFilename() + ".csv")
        }
        function d() {
        ...
        function U(a) {
            ...
            c.forEach( (a, b) => {
                ...
                for (; q--; )
                    f = a[q],
                    "string" === typeof f && (f = '"' + f + '"'),
                    "number" === typeof f && "." !== d && (f = f.toString().replace(".", d)),
                    a[q] = f;
        ...
        function N(a) {
            ...
            const y = g.categoryHeader
              ...
              , w = function(a, b) {
                return a.data.filter(a => "undefined" !== typeof a.y && a.name).length && b && !b.categories && !a.keyToAxis ? a.pointArrayMap && a.pointArrayMap.filter(a => "x" === a).length ? (a.pointArrayMap.unshift("x"),
            ...
            this.series.forEach(function(f) {
                ...
                if (!1 !== f.options.includeInDataExport && !f.options.isInternal && !1 !== f.visible) {
                    ...
                    f.options.data.forEach(function(a, d) {
                        ...
                        m = w.x;
                        G(h[m]) && h[m].seriesIndices.includes(z.index) && (a = Object.keys(h).filter(a => h[a].seriesIndices.includes(z.index) && m).filter(a => 0 === a.indexOf(String(m))),
                        ...
                        for (h[m].seriesIndices = [...h[m].seriesIndices, z.index]; g < D; )
                            d = q[g],
                            a = w[d],
                            h[m][x + g] = v(y.categoryMap[d][a], y.dateTimeValueAxisMap[d] ? c.dateFormat(l.dateFormat, a) : null, a),
                            g++
                    });
                    x += g
                }
            ...
            for (u in h)
                Object.hasOwnProperty.call(h, u) && e.push(h[u]);
            let r, t;
            g = a ? [n, F] : [F];
            for (x = A.length; x--; ) {
                r = A[x][0];
                ...
                e.forEach(function(a) {
                    let b = a.name;
                    k && !G(b) && (k.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()),
                    b = c.dateFormat(l.dateFormat, a.x)) : b = k.categories ? v(k.names[a.x], k.categories[a.x], a.x) : a.x);
                    a.splice(t, 0, b)
                })
            }
            g = g.concat(e);
        ...
        function Z(a) {
            ...
            const e = h ? a.shift() : null
              ...
              , p = function(a, b, c, d) {
                ...
                "," === l && (e = e.replace(".", l)),
                b = "highcharts-number") : d || (b = "highcharts-empty");
                c = R({
                    "class": b
                }, c);
                return {
            ...
            c.push(function(a, b, c) {
                ...
                if (k) {
                    for (k = []; e < c; ++e) {
                        var g = a[e];
                        var q = a[e + 1];
                        g === q ? ++f : f ? (k.push(p("th", "highcharts-table-topheading", {
                            scope: "col",
                            colspan: f + 1
                        }, g)),
                        f = 0) : (g === b[e] ? d.exporting.useRowspanHeaders ? (q = 2,
                        delete b[e]) : (q = 1,
                        b[e] = "") : q = 1,
                        g = p("th", "highcharts-table-topheading", {
                            scope: "col"
                        }, g),
                        1 < q && g.attributes && (g.attributes.valign = "top",
                ...
                if (b) {
                    ...
                    for (c = b.length; e < c; ++e)
                        "undefined" !== typeof b[e] && a.push(p("th", null, {
                            scope: "col"
                        }, b[e]));
                    l.push({
                        tagName: "tr",
        ...
        function ba(b) {
            ...
            c && (this.dataTableDiv = ca.createElement("div"),
        ...
        function P(a, b) {
            ...
            try {
                ...
                if (!d)
                    return e.createObjectURL(new t.Blob(["\ufeff" + a],{
                        type: b
                    }))
            } catch (h) {}
        }
        ...
        const {doc: ca, win: t} = e
          ...
          , {downloadURL: O} = n
          , {series: V, seriesTypes: {arearange: I, gantt: J, map: K, mapbubble: L, treemap: M}} = C
          , {addEvent: T, defined: G, extend: R, find: X, fireEvent: H, isNumber: W, pick: v} = r
          , u = [];
        "";
        return {
            compose: function(a) {
                r.pushUnique(u, a) && (T(a, "afterViewData", ea),
                T(a, "render", fa),
                a = a.prototype,
                a.downloadCSV = c,
                a.downloadXLS = d,
