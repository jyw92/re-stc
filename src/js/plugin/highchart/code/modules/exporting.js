...
(function(a) {
    ...
    module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"], function(e) {
        a(e);
        a.Highcharts = e;
        return a
    ...
    function e(a, l, y, F) {
        a.hasOwnProperty(l) || (a[l] = F.apply(null, y),
    ...
    e(a, "Extensions/Exporting/ExportingDefaults.js", [a["Core/Globals.js"]], function(a) {
        ...
        return {
            ...
            lang: {
                viewFullscreen: "전체화면 보기",
                exitFullscreen: "전체화면 종료",
                printChart: "프린트",
                downloadPNG: "다운로드 PNG",
                downloadJPEG: "다운로드 JPEG",
                downloadPDF: "다운로드 PDF",
                downloadSVG: "다운로드 SVG",
    ...
    e(a, "Extensions/Exporting/ExportingSymbols.js", [], function() {
        ...
        (function(a) {
            function b(a, b, g, c) {
                return [["M", a, b + 2.5], ["L", a + g, b + 2.5], ["M", a, b + c / 2 + .5], ["L", a + g, b + c / 2 + .5], ["M", a, b + c - 1.5], ["L", a + g, b + c - 1.5]]
            }
            function l(a, b, g, c) {
                a = c / 3 - 2;
                c = [];
                return c = c.concat(this.circle(g - a, b, a, a), this.circle(g - a, b + a + 4, a, a), this.circle(g - a, b + 2 * (a + 4), a, a))
            }
            const p = [];
            a.compose = function(a) {
        ...
        class B {
            ...
            close() {
                ...
                p(c, "fullscreenClose", null, function() {
                    if (a.isOpen && a.browserProps && c.container.ownerDocument instanceof Document)
            ...
            setButtonText() {
                ...
                b = b.options.lang;
                m && m.menuItemDefinitions && b && b.exitFullscreen && b.viewFullscreen && M && c && (c = c[M.indexOf("viewFullscreen")]) && a.setElementHTML(c, this.isOpen ? b.exitFullscreen : m.menuItemDefinitions.viewFullscreen.text || b.viewFullscreen)
            }
            toggle() {
          ...
          , g = {
            ajax: function(a) {
                ...
                c.onreadystatechange = function() {
                    ...
                    if (4 === c.readyState) {
                        if (200 === c.status) {
                            if ("blob" !== a.responseType && (b = c.responseText,
                            "json" === a.dataType))
                                try {
                                    b = JSON.parse(b)
                                } catch (z) {
    ...
    e(a, "Extensions/Exporting/Exporting.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Chart/Chart.js"], a["Core/Chart/ChartNavigationComposition.js"], a["Core/Defaults.js"], a["Extensions/Exporting/ExportingDefaults.js"], a["Extensions/Exporting/ExportingSymbols.js"], a["Extensions/Exporting/Fullscreen.js"], a["Core/Globals.js"], a["Core/HttpUtilities.js"], a["Core/Utilities.js"]], function(a, e, y, F, p, A, B, g, c, m) {
        const {defaultOptions: b, setOptions: l} = F
          , {doc: z, SVG_NS: R, win: D} = g
          , {addEvent: C, css: w, createElement: G, discardElement: N, extend: H, find: S, fireEvent: I, isObject: T, merge: k, objectEach: U, pick: q, removeEvent: V, uniqueKey: W} = m;
        var J;
        (function(e) {
            function F(a) {
                const f = this
                ...
                if (!1 !== b.enabled && b.theme) {
                    var v = b.theme, e;
                    f.styledMode || (v.fill = q(v.fill, "#ffffff"),
                    ...
                    : E && (e = function(a) {
                        a && a.stopPropagation();
                        f.contextMenu(r.menuClassName, E, r.translateX, r.translateY, r.width, r.height, r);
                        r.setState(2)
                    }
                    );
                    ...
                    f.styledMode || (v["stroke-linecap"] = "round",
                    ...
                    b.symbol && (x = d.symbol(b.symbol, b.symbolX - n / 2, b.symbolY - n / 2, n, n, {
                        width: n,
                        height: n
            ...
            function M() {
                ...
                [].forEach.call(c.childNodes, function(a, b) {
                    1 === a.nodeType && (c.origDisplay[b] = a.style.display,
            ...
            function Y(b, f, c, e, g, E, n) {
                ...
                ,
                d.exportEvents.push(C(h, "mouseleave", function() {
                ...
                f.forEach(function(b) {
                    ...
                    if (T(b, !0)) {
                        let f;
                        b.separator ? f = G("hr", void 0, void 0, u) : ("viewData" === b.textKey && d.isDataTableVisible && (b.textKey = "hideData"),
                        f = G("li", {
                        ...
                        d.styledMode || (f.onmouseover = function() {
                ...
                c + d.exportMenuWidth > O ? f.right = O - c - g - K + "px" : f.left = c - K + "px";
            ...
            function Z(a) {
                ...
                c && (c.forEach(function(a, b) {
                    a && (m.clearTimeout(a.hideTimer),
                    V(a, "mouseleave"),
                    c[b] = a.onmouseout = a.onmouseover = a.ontouchstart = a.onclick = null,
                    N(a))
                }),
                c.length = 0);
            ...
            function da(a) {
                ...
                this.axes.forEach(function(a) {
                    ...
                    a.options.isInternal || (n[a.coll] || (n[a.coll] = !0,
                    d[a.coll] = []),
                    d[a.coll].push(k(a.userOptions, {
                        visible: a.visible
                    })))
                });
                ...
                function a(d) {
                    ...
                    if (n && 1 === d.nodeType && -1 === ia.indexOf(d.nodeName)) {
                        ...
                        if (!l[d.nodeName]) {
                            ...
                            var u = {};
                            for (var h in p)
                                "string" !== typeof p[h] || /^[0-9]+$/.test(h) || (u[h] = p[h]);
                            l[d.nodeName] = u;
                        ...
                        for (const a in e)
                            if (g.isFirefox || g.isMS || g.isSafari || Object.hasOwnProperty.call(e, a)) {
                                ...
                                t || k[q] === h && "svg" !== d.nodeName || l[d.nodeName][q] === h || (P && -1 === P.indexOf(q) ? f[q] = h : h && d.setAttribute(fa(q), h))
                            }
                        w(d, f);
            ...
            function oa(a, b) {
                ...
                let c = a.substr(d);
                a = a.substr(0, d);
                b && b.exporting && b.exporting.allowHTML && c && (c = '<foreignObject x="0" y="0" width="' + b.chart.width + '" height="' + b.chart.height + '"><body xmlns="http://www.w3.org/1999/xhtml">' + c.replace(/(<(?:img|br).*?(?=>))>/g, "$1 />") + "</body></foreignObject>",
                a = a.replace("</svg>", c + "</svg>"));
                return a = a.replace(/zIndex="[^"]+"/g, "").replace(/symbolName="[^"]+"/g, "").replace(/jQuery[0-9]+="[^"]+"/g, "").replace(/url\(("|&quot;)(.*?)("|&quot;);?\)/g, "url($2)").replace(/url\([^#]+#/g, "url(#").replace(/<svg /, '<svg xmlns:xlink="http://www.w3.org/1999/xlink" ').replace(/ (|NS[0-9]+:)href=/g, " xlink:href=").replace(/\n/, " ").replace(/(fill|stroke)="rgba\(([ 0-9]+,[ 0-9]+,[ 0-9]+),([ 0-9\.]+)\)"/g, '$1="rgb($2)" $1-opacity="$3"').replace(/&nbsp;/g, "\u00a0").replace(/&shy;/g, "\u00ad")
            }
            const Q = []
            ...
            e.compose = function(a, c) {
                A.compose(c);
                B.compose(a);
                m.pushUnique(Q, a) && (c = a.prototype,
                c.afterPrint = J,
                c.exportChart = aa,
                c.inlineStyles = ha,
                c.print = ma,
                ...
                m.pushUnique(Q, l) && (b.exporting = k(p.exporting, b.exporting),
